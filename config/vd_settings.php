...
// add chain_txt default validation group
...
// edt chain_txt default validation group
...
// add chain number default validation group
...
// edt chain_number default validation group
...
// add chain attr default validation group
$chain_attr_add_validation =
array(
    $vd_cre_on,
    $vd_log,
    $vd_cre_by,
...
// edt chain attr default validation group
$chain_attr_edt_validation =
array(
    $vd_cre_on,
    $vd_log,
    $vd_cre_by,
...
//chain span add validation
$chain_span_add_validation =
    array(
            $vd_cre_on,
            $vd_log,
            $vd_cre_by,
