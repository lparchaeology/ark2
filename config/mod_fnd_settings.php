...
*
* Settings file for the module fnd (finds)
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'fnd_itemval', // Must be unique
...
$conf_mcd_fnddesc =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'desc', 
        'sf_html_id' => 'fnd_desc', // Must be unique
...
$conf_mcd_fndimages =
    array(
        ...
        'edit_state' => 'edit',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'images', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'fst_imgs', //the form id tag (must be unique)
