...
// A text subform for the location details
    $conf_mcd_location_text =
        array(
            'view_state' => 'max',
            'edit_state' => 'view',
            'sf_title' => 'textfields', 
...
array(
                ...
                'sf_nav_type' => 'full',
                'sf_title' => 'chrono',
                'sf_html_id' => 'chrono', // Must be unique
                'script' => 'php/subforms/sf_attr_bytype.php',
                'op_label' => 'space',
                'op_input' => 'save',
                'fields' => array(
...
$conf_mcd_chrono_frame =
    array(
        'view_state' => 'min',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmmm',
        'sf_title' => 'chronofunction',
        'sf_html_id' => 'chrono_frame', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'subforms' => array(
