...
$conf_mcd_provperiod =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'provperiod',
        'sf_html_id' => 'provperiod', // Must be unique
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => 
...
$conf_mcd_reccomplete =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'recordcomplete', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_reccomplete', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_boolean_switch.php',
        'op_label' => 'space',
        'op_input' => 'edt',
        'fields' =>
            array(
...
array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'cxtsummary', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'sf_cxtsummary', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_summary.php',
        'fields' =>
        array(
                'txt'=>$conf_field_short_desc,
...
$conf_register =
    array(
        ...
        'op_label' => 'save',
        'op_input' => 'save',
        'op_num_rows' => 12, // relevant to tbl not sgl
