...
$conf_mcd_grpdatingnarrative =
    array(
        'view_state' => 'max',
        'edit_state' => 'view', //not yet setup in sf
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'grpdatingnarrative', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_dating_narrative', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_interp.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => array(
...
// FRAMES HOLDING MULTIPLE SUBFORMS
$conf_mcd_grpbasicframe =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'basicinfo', 
        'sf_html_id' => 'grp_basicframe', // Must be unique
...
$conf_mcd_grpphase =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'phase',
        'sf_html_id' => 'phase', // Must be unique
