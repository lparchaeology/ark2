...
$link_list_stditem [] = 
    array (
        'href' => "{$_SERVER['PHP_SELF']}?ftype=key&amp;key=8&amp;ftr_id=new",
        'mknname' => 'filtersgr',
        'img' => 'view_mag.png',
        'lightbox' => FALSE,
        'css_class' => FALSE 
...
$link_list_stditem[] =
    array(
        'href' => "{$_SERVER['PHP_SELF']}?ftype=key&amp;key=11&amp;ftr_id=new",
        'mknname' => 'filtergrp',
        'img' => 'view_mag.png',
        'lightbox' => FALSE,
        'css_class' => FALSE
...
$link_list_stdcriteria[] =
    array(
        'href' => "{$_SERVER['PHP_SELF']}?ftype=atr&amp;atrtype=2&amp;bv=1&amp;ftr_id=new", 
        'mknname' => 'ftr_find_type',
        'img' => 'view_mag.png',
        'lightbox' => FALSE,
        'css_class' => FALSE
);
...
$wxs_qlayers = 
    array(
        'contexts' => array(
                'mod' => 'cxt',
                'geom' => 'pgn',
                'url' => 'yourmapserverhere- must be valid when appended with &request=getcapabilities'
        ),
