...
$conf_mcd_details =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'pho_details', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'details', //the form id tag (must be unique)
...
$conf_mcd_xmicat =
    ...
    $conf_mcd_phometa =
         array(
            ...
            'script' => 'mod_code/subforms/sf_metadataupdater.php',
            'op_label' => 'space',
            'op_input' => 'save',
            'op_moddif' => TRUE,
            'irods_info' => array (
            ...
            'metadata' => array (
                            ...
                            array('isPartOf',   "field"),// Dependant on module, will always be field whilst this is a sph - cannot be changed 
                                                         // difficult to change on ark, can be pushed to irods
