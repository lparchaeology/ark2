...
$conf_field_itemkey =
    array(
        ...
        'dataclass' => 'itemkey',
        'classtype' => 'ael_cd', //this is needed to correctly request the qtype
...
$conf_mcd_aeldesc =
    array(
        ...
        'sf_html_id' => 'ael_description', //the form id tag (must be unique)
...
$conf_mcd_aelcomparanda = 
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'comparanda',
        'sf_html_id' => 'ael_comparanda',
...
$conf_mcd_note =
    array(
        ...
        'sf_html_id' => 'ael_interp', //the form id tag (must be unique)
...
$conf_mcd_aelevent =
    array(
        ...
        'sf_html_id' => 'ael_events', //the form id tag (must be unique)
...
$conf_mcd_aph =
  array(
      ...
      'sf_html_id' => 'ael_img_display', //the form id tag (must be unique)
...
$conf_mcd_xmiael =
    array(
        ...
        'sf_html_id' => 'ael_xmi_cxts', //the form id tag (must be unique)
...
$conf_register =
    array(
        ...
        'sf_html_id' => 'ael_cd_register', //the form id tag (must be unique)
