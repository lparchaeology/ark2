...
$conf_field_itemkey =
    array(
        ...
        'dataclass' => 'itemkey',
        'classtype' => 'gph_cd', //this is needed to correctly request the qtype
...
$conf_mcd_gphdesc =
    array(
        ...
        'sf_html_id' => 'gph_img_desc', //the form id tag (must be unique)
...
$conf_mcd_gphevent =
    array(
        ...
        'sf_html_id' => 'gph_event_desc', //the form id tag (must be unique)
...
$conf_mcd_xmigph =
    array(
        ...
        'sf_html_id' => 'gph_xmi_cxts', //the form id tag (must be unique)
...
$conf_mcd_gph =
  array(
      ...
      'sf_html_id' => 'gph_img_display', //the form id tag (must be unique)
...
$conf_register =
    array(
        ...
        'sf_html_id' => 'gph_cd_register', //the form id tag (must be unique)
