...
/**
* config/mod_ill_settings.php
*
* Settings file for the module ill (illes)
...
$conf_mcd_itemval_conflicts =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'dnarecord', 
        'sf_html_id' => 'ill_itemvalconflict', // Must be unique
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'ill_itemval', // Must be unique
...
$conf_mcd_modtype_conflicts =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'illtypeconflicts', 
        'sf_html_id' => 'ill_modtypeconflict', // Must be unique
...
$conf_mcd_modtype =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'illtype', 
        'sf_html_id' => 'ill_modtype', // Must be unique
...
// A text subform for the illustration notes
    $conf_mcd_notes =
        array(
            'view_state' => 'max',
            'edit_state' => 'view',
            'sf_title' => 'notes', 
            'sf_html_id' => 'ill_notes', // Must be unique
...
// A text subform for the location area
    $conf_mcd_source =
        array(
            ...
            'edit_state' => 'view',
            'sf_title' => 'source', 
            'sf_html_id' => 'ill_source', // Must be unique
            'script' => 'php/subforms/sf_txt.php',
            'sf_nav_type' => 'nmedit',
            'op_label' => 'space',
            'op_input' => 'save',
...
// A text subform for the desc
    $conf_mcd_desc =
        array(
            ...
            'edit_state' => 'view',
            'sf_title' => 'ill_desc', 
            'sf_html_id' => 'ill_desc', // Must be unique
            'script' => 'php/subforms/sf_txt.php',
            'sf_nav_type' => 'nmedit',
            'op_label' => 'space',
            'op_input' => 'save',
...
// An event subform, for the illustration creation

$conf_event_created = 
    array(
        'type' => 'created',
        'date' => $conf_field_ill_created,
        'action' => $conf_field_illustration,
);
...
$conf_mcd_datecreated =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'created', 
        'sf_html_id' => 'ill_created', // Must be unique
...
// A text subform for illustration notes
    $conf_mcd_notes =
        array(
            'view_state' => 'max',
            'edit_state' => 'view',
            'sf_title' => 'notes', 
            'sf_html_id' => 'pho_notes', // Must be unique
            'script' => 'php/subforms/sf_txt.php',
            'sf_nav_type' => 'name',
            'op_label' => 'space',
            'op_input' => 'save',
...
// A text subform for the file source
    $conf_mcd_source =
        array(
            'view_state' => 'max',
            'edit_state' => 'view',
            'sf_title' => 'source', 
            'sf_html_id' => 'pho_source', // Must be unique
            'script' => 'php/subforms/sf_txt.php',
            'sf_nav_type' => 'nmedit',
            'op_label' => 'space',
            'op_input' => 'save',
...
$conf_mcd_ill =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'illustration', //appears in the titlebar of the subform (mk nname)
...
$conf_mcd_xmicat =
    array(
        ...
        'sf_html_id' => 'ill_cat_display', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'nmedit',
        'xmi_mode' => 'live',
        'xmi_mod' => 'cat',
...
$conf_mcd_metadata_frame =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'metadata', 
        'sf_html_id' => 'metadata_frame', // Must be unique
...
$conf_register =
    array(
        ...
        'edit_state' => 'edit',
        'sf_title' => 'register', 
        'sf_html_id' => 'ill_cd_register', // Must be unique
        'sf_nav_type' => 'none',
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_ill_userconf', // Must be unique
