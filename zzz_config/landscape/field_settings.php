...
$conf_field_visibility =
    array(
        'field_id' => 'conf_field_visibility',
        'dataclass' => 'txt',
...
$conf_field_metsur_kess =
    array(
        'field_id' => 'conf_field_metsur_locs',
        'id' => 'known_excav_sites',
        'dataclass' => 'geom',
        'module' => 'loc',
        'type' => 'WFS',
        'url' => 'http://'.$_SERVER['SERVER_NAME'].'/geoserver/MetSur/wfs?',
        'name' => 'known_excav_sites',
        'projection' => "EPSG:900913",
        'op_layer'=> 'METSUR_known_excav_sites',
        'op_zoomtolayer' => FALSE,
        'op_serverType'=> 'geoserver',
        'op_query' => 'FALSE',
        'op_buffer' => '500'
...
$conf_field_metsur_locs_line =
    array(
        ...
        'type' => 'WFS',
        'url' => 'http://'.$_SERVER['SERVER_NAME'].'/geoserver/MetSur/wfs?',
        'name' => 'metsur_locs_line',
        'projection' => "EPSG:900913",
        'op_layer'=> 'divlines_ap_dir',
        'op_zoomtolayer' => FALSE,
        'op_serverType'=> 'geoserver',
        'op_query' => 'FALSE',
        'op_buffer' => '50'
...
$conf_field_metsur_locs_poly =
    array(
        ...
        'type' => 'WFS',
        'url' => 'http://'.$_SERVER['SERVER_NAME'].'/geoserver/MetSur/wfs?',
        'name' => 'metsur_locs_poly',
        'projection' => "EPSG:900913",
        'op_layer'=> 'METSUR_loc_areas_merged',
        'op_zoomtolayer' => FALSE,
        'op_serverType'=> 'geoserver',
        'op_query' => 'FALSE',
        'op_buffer' => '50'
