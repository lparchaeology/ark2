...
/**
* config/mod_cat_settings.php
*
* Settings file for the module cat (cataloged finds)
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'cat_itemval', // Must be unique
...
$conf_mcd_catcode =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'code', 
        'sf_html_id' => 'cat_code', // Must be unique
...
$conf_mcd_catdesc =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'desc', 
        'sf_html_id' => 'cat_desc', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_lw_txt =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'otherdesc', 
        'sf_html_id' => 'lw_desc', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_amp_txt =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'otherdesc', 
        'sf_html_id' => 'amp_desc', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_tombcat_txt =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_title' => 'otherdesc', 
        'sf_html_id' => 'tombcat_txt', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_coin_txt =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'otherdesc', 
        'sf_html_id' => 'coin_desc', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_cattext =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'item_text', 
        'sf_html_id' => 'cat_text', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_catattr =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'find_attributes',
        'sf_html_id' => 'find_attributes', // Must be unique
...
$conf_mcd_coin_attr =
    array(
        ...
        'edit_state' => 'view',
        'sf_title' => 'material', 
        'sf_html_id' => 'coin_attr', // Must be unique
        'script' => 'php/subforms/sf_attr_bytype.php',
        'sf_nav_type' => 'name',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_finddates = 
        array(
            ...
            'sf_html_id' => 'cat_cd_chronology', //the form id tag (must be unique)
...
$conf_mcd_num_examples =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'numExamples', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'numExamples', //the form id tag (must be unique)
...
$conf_mcd_phoxmi =
    array(
        ...
        'sf_html_id' => 'cat_pho_display', //the form id tag (must be unique)
...
$conf_mcd_locxmi =
    array(
        ...
        'sf_html_id' => 'cat_loc_display', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'none',
        'xmi_mod' => 'loc',
        'xmi_mode' => 'live',
...
$conf_mcd_illxmi =
    array(
        'view_state' => 'max',
        'edit_state' => 'view', //not yet setup in sf
        'sf_title' => 'illus', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cat_ill_display', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'none',
        'xmi_mod' => 'ill',
        'xmi_mode' => 'live',
