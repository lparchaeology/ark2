...
$conf_map_add_interaction =
    array(
        'sf_conf_id' => 'conf_map_add_interaction',
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'full',
...
$conf_map_delete_interaction =
    array(
        'sf_conf_id' => 'conf_map_delete_interaction',
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'full',
...
$conf_map_save_interaction =
    array(
        'sf_conf_id' => 'conf_map_save_interaction',
                'view_state' => 'max',
                'edit_state' => 'view',
                'sf_nav_type' => 'full',
...
$conf_map_layerswitcher =
    array(
            ...
            'op_class' => 'panel',
            'op_overlay' => false,
            'op_sf_cssclass' => 'layerswitcher mc_subform',
            'fields' => array(
            )
        );
$conf_map_home =
...
$conf_mapsf_grouptool =
    array(
        'sf_conf_id' => 'conf_mapgrouptool',
        'view_state' => 'max',
        'edit_state' => 'edit',
        'sf_nav_type' => 'full',
        'sf_title' => 'addinteraction',
        ...
        'op_icon' => 'addinteraction.png',
        'op_overlay' => false,
        'op_sf_cssclass' => 'mappanel',
        'target_module' => 'sgr',
        'subform' => 'conf_mcd_grp',
        'fields' => array(
