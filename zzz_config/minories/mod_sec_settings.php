...
$conf_mcd_itemval_conflicts =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'dnarecord', 
        'sf_html_id' => 'sec_itemvalconflict', // Must be unique
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'sec_itemval', // Must be unique
...
$conf_mcd_details =
    array(
        ...
        'sf_html_id' => 'sec_attributes', // Must be unique
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_sec_userconf', // Must be unique
