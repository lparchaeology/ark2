...
$conf_mcd_details =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'phoattributes',
        'sf_html_id' => 'sph_phoattributes', // Must be unique
...
$conf_mcd_tmbxmi =
    array(
        'view_state' => 'max',
        'edit_state' => 'view', //not yet setup in sf
        'sf_title' => 'sph_timbers', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'sph_tmb_display', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'nmedit',
        'xmi_mode' => 'live',
        'xmi_mod' => 'tmb',
...
$conf_mcd_share =
    array(
            ...
            'sf_html_id' => 'sph_share_buttons', //the form id tag (must be unique)
