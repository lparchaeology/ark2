...
$conf_mcd_othercoments =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'other', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'smp_othercomments', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'op_emptyfielddisp' => TRUE,
...
$conf_mcd_xmicxt =
	...
	array(
	        ...
	        'sf_html_id' => 'smp_share_buttons', //the form id tag (must be unique)
...
$conf_mcd_descfrm =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'desc', 
        'sf_html_id' => 'smp_desc_frame', // Must be unique
...
$conf_mcd_hvyfracfrm =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'hvyfrac', 
        'sf_html_id' => 'smp_hvy_fracfrm', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'subforms' =>
...
$conf_mcd_lghfracfrm =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'lghfrac', 
        'sf_html_id' => 'smp_lgh_fracfrm', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'subforms' =>
...
$conf_mcd_statusframe =
    array(
        ...
        'sf_html_id' => 'smp_status_frame', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
        'op_input' => 'save',
		'op_sf_cssclass' => 'officeuse mc_subform',
        'subforms' =>
            array(
                $conf_mcd_samplestatus,
                $conf_mcd_statusnotes,
