...
/**
* config/mod_tmb_settings.php
*
* Settings file for the module tmb (registered finds)
...
* @link       http://ark.lparchaeology.com/svn/config/ark_cxt/mod_tmb_settings.php
...
$conf_mcd_itemval_conflicts =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'dnarecord', 
        'sf_html_id' => 'tmb_itemvalconflict', // Must be unique
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'tmb_itemval', // Must be unique
...
$conf_mcd_tmbdesc =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_title' => 'regdesc', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_img_desc', //the form id tag (must be unique)
...
$conf_mcd_tmbcomment =
    array(
        'view_state' => 'max',
        'edit_state' => 'edit',
        'sf_title' => 'tmb_comment', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_comment', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'nmedit',
        'op_emptyfielddisp' => TRUE,
        'op_label' => 'space',
...
$conf_mcd_tmbstatus =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'tmb_status', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_status', //the form id tag (must be unique)
...
$conf_mcd_xmitmbcxt =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'tmbxmicxt', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_xmi_cxts', //the form id tag (must be unique)
...
$conf_mcd_plnxmitmb =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'tmbxmipln', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_xmi_pln', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'op_label' => 'link',
        'op_input' => 'add',
        'xmi_mod' => 'pln',
...
$conf_mcd_xmisph =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'tmb_photos', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_xmi_photos', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'op_label' => 'link',
        'op_input' => 'add',
        'xmi_mod' => 'sph',
...
$conf_mcd_event =
    array(
        ...
        'sf_html_id' => 'tmb_events', //the form id tag (must be unique)
...
$conf_tmb_file =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'tmb_files', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'tmb_file_display', //the form id tag (must be unique)
...
$conf_register =
    array(
        ...
        'sf_html_id' => 'tmb_cd_register', //the form id tag (must be unique)
        'sf_nav_type' => 'none',
        'script' => 'php/subforms/sf_register_tbl.php',
        'op_label' => 'save',
        'op_input' => 'save',
        'op_no_rows' => 5, // relevant to tbl not sgl
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_tmbuserconf', // Must be unique
...
$tmb_xmiconf =
    array(
        ...
        'fields' => 
            array(
                $conf_field_short_desc,
                // $conf_field_tmbperiod,
                // $conf_field_tmbbasicinterp,
                // $conf_field_tmbmaterial,
        )
);
