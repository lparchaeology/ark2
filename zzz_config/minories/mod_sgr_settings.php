...
array(
        ...
        'sf_html_id' => 'cxttbl', //the form id tag (must be unique)
        'sf_nav_type' => 'nmedit',
...
$conf_mcd_grp =
    array(
        ...
        'sf_html_id' => 'cxt_grp_display', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'nmedit',
...
$conf_mcd_datingnarrative =
    array(
        ...
        'sf_html_id' => 'dating_narrative', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => array(
