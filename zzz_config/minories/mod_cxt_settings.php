...
$conf_mcd_short_desc =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'cxt_reg_text', //appears in the titlebar of the subform (mk nname)
...
array(
                ...
                'sf_nav_type' => 'nmedit',
                'sf_title' => 'cxt_reg_text', //appears in the titlebar of the subform (mk nname)
                'sf_html_id' => 'cxt_reg_desc', //the form id tag (must be unique)
                'script' => 'php/subforms/sf_txt.php',
                'op_label' => 'space',
                'op_input' => 'save',
                'fields' =>
...
$conf_sgr_interp =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'cxt_desc', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_sgrinterp', //the form id tag (must be unique)
        'script' => 'php/sgr_view/subforms/sf_interp.php',
        'op_label' => 'space',
        'op_input' => False,
        'op_copy_button' => 'cxt_reg_desc',
        'fields' => 
            array(
                $conf_field_interp, 
...
$conf_mcd_cxtlocn =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'cxtlocn',
        'sf_html_id' => 'cxt_locn', // Must be unique
...
$conf_mcd_tmbrxsec =
    array(
        ...
        'sf_nav_type' => 'none',
        'sf_title' => 'bark',
        'sf_html_id' => 'cxt_bark', // Must be unique
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => 
...
$conf_mcd_reuseattr =
    array(
        ...
        'sf_nav_type' => 'none',
        'sf_title' => 'reuseattr',
        'sf_html_id' => 'cxt_reuseattr', // Must be unique
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => 
...
$conf_mcd_reusetxt =
    array(
        ...
        'sf_nav_type' => 'full',
        'sf_title' => 'reusetxt', 
        'sf_html_id' => 'cxt_reusetxt', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_basicinterpsgr =
    array(
        'view_state' => 'max',
        'edit_state' => 'edit',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'basicinterp', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_basicinterpsgr', //the form id tag (must be unique)
        'script' => 'php/sgr_view/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'op_moddif' => TRUE,
        'fields' => 
...
$conf_mcd_sgrxmi =
    array(
        'view_state' => 'max',
        'edit_state' => 'view', // not yet setup in sf
        'sf_title' => 'subgroup', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_sgr_display', // the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'nmedit',
        'xmi_mode' => 'live',
        'xmi_mod' => 'sgr',
...
$conf_sgr_sgrxmi =
    array(
        ...
        'sf_title' => 'subgroup', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_sgr_display', // the form id tag (must be unique)
        'script' => 'php/sgr_view/subforms/sf_sgr.php',
        'sf_nav_type' => 'nmedit',
        'xmi_mode' => 'auto',
        'xmi_mod' => 'sgr',
        'op_lightbox' => TRUE,
...
// Display registered section links
$conf_mcd_sec =
    array(
        'view_state' => 'max',
        'edit_state' => 'view', //not yet setup in sf
        'sf_title' => 'sections', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_sec_display', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'sf_nav_type' => 'nmedit',
        'xmi_mode' => 'live',
        'xmi_mod' => 'sec',
...
// Display submitallbutton
$conf_mcd_submitall =
    array(
                'view_state' => 'max', 
                'edit_state' => 'view', // not yet setup in sf
                'sf_title' => 'submitall', // appears in the titlebar of the subform (mk nname)
                'sf_html_id' => 'cxt_sgr_submitall', // the form id tag (must be unique)
                'script' => 'php/subforms/sf_submitall.php',
                'sf_nav_type' => 'none',
                'subforms' =>
                    array(
                        $conf_mcd_basicinterp,
...
$conf_mcd_spat = 
    array(
        ...
        'selectInteraction' => 'genSelectMultiInteraction',
        'op_shrgeom_spantype' => 'shrgeom',
        'op_map'=>2,
        'fields' => array(
...
array(
                ...
                'sf_nav_type' => 'none',
                'script' => 'php/sgr_view/subforms/sf_recent_edits.php',
                'op_label' => 'save',
                'op_input' => 'save',
                'op_num_rows' => 8, // relevant to tbl not sgl
...
$conf_cxt_file =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'cxt_files', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_file_display', //the form id tag (must be unique)
...
$conf_mcd_under_construction =
    array(
        ...
        'sf_html_id' => 'cxt_message', //the form id tag (must be unique)
...
$conf_register =
    array(
        ...
        'op_label' => 'save',
        'op_input' => 'save',
        'op_num_rows' => 5, // relevant to tbl not sgl
        'op_sf_cssclass' => 'register',
        'fields' => 
            array(
                $conf_field_locn,
...
/**  SGR VIEW (SUBGROUP VIEW)
 *
 * Subgroup view is a specialised microview page
 *
 */
...
$cxt_xmiconf =
    array(
        ...
        'op_xmi_sort_field' => $conf_field_cxt_cd,
        'fields' => 
            array(
                $conf_field_cxttype,
                $conf_field_locn,
...
// A module might be asked to describe itself in a pop up on a map
// This conf describes how it will do that
$cxt_map_pop_conf =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'none',
        'sf_title' => 'mappop',
        'sf_html_id' => 'cxt_mappop', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
...
$conf_api_interp =
    array(
        ...
        'edit_state' => 'edit', //not yet setup in sf
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'api_interp', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'cxt_api_interp', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' =>
...
$conf_api_modtype =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'api_modtype',
        'sf_html_id' => 'cxt_api_modtype', // Must be unique
        'script' => 'php/subforms/sf_txt.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' =>
...
$cxt_api_sum_conf =
    array(
        ...
        'sf_nav_type' => 'none',
        'sf_title' => 'apisum',
        'sf_html_id' => 'cxt_apisum', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
        'op_sf_cssclass' => 'popup_frame',
        'op_input' => 'save',
