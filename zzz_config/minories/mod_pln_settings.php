...
$conf_mcd_planattribs =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'plnattr',
        'sf_html_id' => 'plnattr', // Must be unique
...
$conf_pln_drawings =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'pln_drawings', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'pln_drawings_display', //the form id tag (must be unique)
