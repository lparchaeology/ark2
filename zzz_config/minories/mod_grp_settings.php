...
$conf_mcd_itemval_conflicts =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'dnarecord', 
        'sf_html_id' => 'grp_itemvalconflict', // Must be unique
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'grp_itemval', // Must be unique
...
$conf_mcd_description =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nm_edit',
        'sf_title' => 'grpdesc', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_short_description', //the form id tag (must be unique)
...
// a subform for the XMI sgr <-> grp
$conf_mcd_sgrxmi =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'sgrs', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_xmi_sgrs', //the form id tag (must be unique)
...
// a subform for the XMI lus <-> grp
$conf_mcd_lusxmi =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'lus', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_xmi_luss', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'op_label' => 'link',
        'op_input' => 'add',
        'xmi_mod' => 'lus',
...
$conf_mcd_grpnarrative =
    array(
        'view_state' => 'max',
        'edit_state' => 'view', //not yet setup in sf
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'grpnarrative', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_narrative', //the form id tag (must be unique)
...
// final definitive phase
$conf_mcd_grpperiod =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_title' => 'period', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_period', //the form id tag (must be unique)
        'sf_nav_type' => 'nmedit',
...
$conf_mcd_grpattr =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_title' => 'grpproc', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_grpattr', //the form id tag (must be unique)
        'sf_nav_type' => 'nmedit',
        'script' => 'php/subforms/sf_attr_bytype.php',
        // 'op_chart' => 'yes',
        'op_label' => 'space',
...
$conf_mcd_grpsgrxmi =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'grpsgrxmi', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'grp_xmi_sgr', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_xmi.php',
        'op_label' => 'link',
        'op_input' => 'add',
        'xmi_mod' => 'sgr',
...
$conf_mcd_grpspat = 
 ...
 $conf_mcd_under_construction =
     array(
         ...
         'sf_html_id' => 'grp_message', //the form id tag (must be unique)
...
*  using $conf_field_grp_cd['add_validation'][] = $key_vd_modtype;
*
*/
...
$conf_register =
    array(
        ...
        'sf_html_id' => 'grp_register', //the form id tag (must be unique)
        'sf_nav_type' => 'none',
...
$conf_mcd_reggrp =
    array(
        ...
        'sf_title' => 'register', 
        'sf_html_id' => 'grp_cd_register', // Must be unique
        'script' => 'php/subforms/sf_register_sgl.php',
        'op_label' => 'save',
        'op_input' => 'save',
        'op_register_mod' => 'grp', // overlayed reg's need this IF overlayed mod differs from page's mod
        'fields' => 
            array(
                $conf_field_grp_cd,  // name field
                $conf_field_short_desc,
                $conf_reg_op
        )
);
    ...
    array(
        ...
        'subforms' =>
            array(
                ...
                // $conf_mcd_grpattr,
                // $conf_mcd_grpmatrix,
                // $conf_mcd_grpspat // commented out (see above)
        )
);
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_grpuserconfigfields', // Must be unique
...
$grp_map_pop_conf =
    array(
        ...
        'sf_nav_type' => 'none',
        'sf_title' => 'mappop',
        'sf_html_id' => 'grp_mappop', // Must be unique
