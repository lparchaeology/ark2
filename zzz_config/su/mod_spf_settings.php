...
$conf_field_itemkey =
    array(
        ...
        'dataclass' => 'itemkey',
        'classtype' => 'spf_cd', //this is needed to correctly request the qtype
...
$conf_mcd_spfdesc =
    array(
        ...
        'sf_html_id' => 'spf_description', //the form id tag (must be unique)
...
$conf_mcd_damage =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'damage', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'spf_damage', //the form id tag (must be unique)
...
$conf_mcd_cond =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'name',
        'sf_title' => 'cond', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'spf_condition', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => array(
...
$conf_mcd_further_work =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'name',
        'sf_title' => 'further_work', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'spf_further_work', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => array(
...
$conf_mcd_priority =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'name',
        'sf_title' => 'priority', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'spf_priority', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => array(
...
$conf_mcd_consattr =
    array(
        ...
        'sf_nav_type' => 'name',
        'sf_title' => 'priority', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'spf_consattr', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_attr_bytype.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'fields' => array(
...
$conf_mcd_spfcons =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'name',
        'sf_title' => 'cons', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'spf_cons', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
...
$conf_mcd_storage =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'name',
        'sf_title' => 'storage', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'storage', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
        'op_emptyfielddisp' => TRUE,
        'op_label' => 'space',
        'op_input' => 'save',
...
$conf_mcd_spfnote =
    array(
        ...
        'sf_html_id' => 'spf_interp', //the form id tag (must be unique)
...
$conf_mcd_spfevent =
    array(
        ...
        'sf_html_id' => 'spf_events', //the form id tag (must be unique)
...
$conf_mcd_fph =
    array(
        ...
        'sf_html_id' => 'fph_img_display', //the form id tag (must be unique)
        'script' => 'php/subforms/subform_imageviewer.php',
        'xmi_mod' => 'fph',
        'op_lightbox' => TRUE
);
...
$conf_mcd_xmispf =
    array(
        ...
        'sf_html_id' => 'spf_xmi_cxts', //the form id tag (must be unique)
...
$conf_mcd_descframe =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'desc', 
        'sf_html_id' => 'spf_descframe', // Must be unique
...
$conf_mcd_consframe =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'cons', 
        'sf_html_id' => 'spf_consframe', // Must be unique
        'script' => 'php/subforms/sf_frame.php',
        'op_label' => 'space',
        'op_input' => 'save',
        'subforms' => array(
...
$conf_register =
    array(
        ...
        'sf_html_id' => 'spf_cd_register', //the form id tag (must be unique)
