...
$link_list_stditem[] =
    array(
        'href' => "{$_SERVER['PHP_SELF']}?ftype=key&amp;key=10&amp;ftr_id=new", 
        'mknname' => 'filtercxt',
        'img' => 'view_mag.png',
        'lightbox' => FALSE,
        'css_class' => FALSE
...
$dvlp_traverse_toggle =
array(
    'view_state' => 'min',
    'edit_state' => 'view',
    'sf_nav_type' => 'name',
    'sf_title' => 'togltrav',
    'sf_html_id' => 'dvlp_togltrav', // Must be unique
    'script' => 'php/subforms/sf_travtogl.php',
    'op_modtype' => FALSE, // if each modtype uses same fields (see below)
                           // Does the linklist use an icon instead of a label as link
    'op_linktype' => 'link',
    'op_sf_cssclass' => 'ftr_list',
    'op_trav_to' => 'asm', // mod code for traverse toggle
    'fields' => FALSE
);
