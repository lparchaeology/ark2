...
if ($files){
    ...
    if (file_exists("{$registered_files_dir}/arkthumb_{$image['id']}.jpg")){
        $profilephoto = "{$registered_files_path}/arkthumb_{$image['id']}.jpg";
    }
}
...
<div class="photo">
<div class="mask"><a href="<?php print $ark_root_path?>/micro_view.php?item_key=abk_cd&abk_cd=<?php print $abk_cd?>"> <img src="<?php print $skin_path?>/images/common/mask-profile-photo.svg" alt="" /></a></div>
<img src="<?php print $profilephoto ?>" alt="" />
</div>
<p class="name"><a href="<?php print $ark_root_path?>/micro_view.php?item_key=abk_cd&abk_cd=<?php print $abk_cd?>"><?php print $soft_name?></a></p>
