...
* @link       http://ark.lparchaeology.com/code/php/subforms/sf_sitenav.php
* @since      2.0
*/
...
switch ($sf_state) {
   ...
   default:
       echo "<div id=\"sf_sitenav\" class=\"{$sf_cssclass}\">\n";
       echo "<h3>No SF State</h3>\n";
       echo "<p>ADMIN ERROR: the sf_state for sf_sitenav was incorrectly set</p>\n";
