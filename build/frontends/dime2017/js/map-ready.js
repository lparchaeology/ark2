$(document).ready(function () {
    ...
    if ($('#mapmodal').length) {
        ...
        $('#mappickclose').on('click',function(e){e.preventDefault();$("#mapmodal").modal('hide');});

        $("#map-modal").on("hidden.bs.modal", function() {    // remove the event listeners when the dialog is dismissed
            console.log("hide");
        });
    }
