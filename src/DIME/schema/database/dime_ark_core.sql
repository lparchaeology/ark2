...
--
-- Host: localhost
-- Generation Time: May 31, 2017 at 08:15 PM
...
('actor', 'item', 'ARK\\Actor\\Actor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.actor'),
...
('image', 'item', 'ARK\\File\\Image', NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 'ARK\\Form\\Type\\ImageCollectionType', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.image'),
...
('message', 'item', 'ARK\\Message\\Message', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.actor'),
...
('version', 'object', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ARK\\Form\\Type\\FilePropertyType', 1, 0, 0, 0, 0, 1, 1, 0, 'format.fileversion'),
...
('address', 'city', 1, 'string', NULL, 0, 0, 1, 1, 1, 0, 1, 0, 'format.address.city'),
('address', 'country', 2, 'term', 'country', 0, 0, 1, 1, 1, 0, 1, 0, 'format.address.country'),
('address', 'postcode', 0, 'string', NULL, 1, 0, 1, 1, 1, 0, 1, 0, NULL),
...
('core.actor', 'actor', 'avatar', 'image', NULL, 'public', NULL, NULL, 0, 1, 1, 1, 0, 1, 0, 'core.actor.avatar'),
...
('core.actor', 'actor', 'id', 'identifier', NULL, 'restricted', 'core.actor.read', 'core.actor.update', 0, 1, 1, 1, 0, 1, 0, 'dime.actor.id'),
('core.actor', 'actor', 'initials', 'shorttext', NULL, 'public', NULL, NULL, 0, 1, 1, 1, 0, 1, 0, 'core.actor.initials'),
('core.actor', 'actor', 'license', 'term', 'core.license', 'restricted', 'core.actor.read', 'core.actor.update', 0, 1, 1, 1, 0, 1, 0, 'core.actor.type'),
...
('core.actor', 'actor', 'visibility', 'term', 'core.visibility', 'restricted', 'core.actor.read', 'core.actor.update', 0, 1, 1, 1, 0, 1, 0, 'core.actor.type'),
...
('core.actor.biography', 'dime', 0, 0),
('core.actor.email', 'dime', 0, 0),
...
('core.actor.fullname', 'dime', 0, 0),
('core.actor.initials', 'dime', 0, 0),
('core.actor.institution', 'core', 0, 0),
('core.actor.person', 'core', 0, 0),
('core.actor.shortname', 'dime', 0, 0),
('core.actor.telephone', 'dime', 0, 0),
('core.actor.type', 'core', 0, 0),
('core.button.save', 'dime', 0, 0),
('core.button.search', 'dime', 0, 0),
('core.button.send', 'dime', 0, 0),
...
('core.message.recipient.status', 'core', 0, 0),
...
('core.user', 'dime', 0, 0),
('core.user.login', 'dime', 0, 0),
('core.user.password', 'dime', 0, 0),
('core.user.register.existing', 'dime', 0, 0),
('core.user.register.heading', 'dime', 0, 0),
('core.user.register.loggedin', 'dime', 0, 0),
('core.user.register.login', 'dime', 0, 0),
('core.user.register.logout', 'dime', 0, 0),
('core.user.username', 'dime', 0, 0),
('core.visibility', 'core', 0, 0),
('core.widget.send', 'dime', 0, 0),
...
('dime.action.accession', 'core', 0, 0),
('dime.action.activate', 'core', 0, 0),
('dime.action.agree', 'core', 0, 0),
('dime.action.annotate', 'core', 0, 0),
('dime.action.appraise', 'core', 0, 0),
('dime.action.approve', 'core', 0, 0),
('dime.action.assess', 'core', 0, 0),
('dime.action.cancel', 'core', 0, 0),
('dime.action.cite', 'core', 0, 0),
('dime.action.classify', 'core', 0, 0),
('dime.action.comment', 'core', 0, 0),
('dime.action.conserve', 'core', 0, 0),
('dime.action.contact', 'core', 0, 0),
('dime.action.date', 'core', 0, 0),
('dime.action.decline', 'core', 0, 0),
('dime.action.delete', 'core', 0, 0),
('dime.action.describe', 'core', 0, 0),
('dime.action.destroy', 'core', 0, 0),
('dime.action.disagree', 'core', 0, 0),
('dime.action.discard', 'core', 0, 0),
('dime.action.edit', 'dime', 0, 0),
('dime.action.evaluate', 'core', 0, 0),
('dime.action.export', 'core', 0, 0),
('dime.action.follow', 'core', 0, 0),
('dime.action.identify', 'core', 0, 0),
('dime.action.like', 'core', 0, 0),
('dime.action.loan', 'core', 0, 0),
('dime.action.lose', 'core', 0, 0),
('dime.action.notify', 'core', 0, 0),
('dime.action.publish', 'core', 0, 0),
('dime.action.receive', 'core', 0, 0),
...
('dime.actor.kommuner', 'core', 0, 0),
('dime.actor.municipalities', 'dime', 0, 0),
('dime.actor.type', 'dime', 0, 0),
('dime.actor.type.institution', 'vocabulary', 0, 0),
('dime.actor.type.museum', 'vocabulary', 0, 0),
('dime.actor.type.person', 'vocabulary', 0, 0),
...
('dime.find.visibility.private', 'vocabulary', 0, 0),
('dime.find.visibility.public', 'vocabulary', 0, 0),
('dime.find.visibility.restricted', 'vocabulary', 0, 0),
...
('dime.role.reasearcher', 'core', 0, 0),
...
('da', 'core.message.newmessages', 'default', 'Nye Underretninger', NULL),
...
('da', 'dime.actor.id', 'default', 'Aktører ID', NULL),
('da', 'dime.actor.municipalities', 'default', 'Kommuner', NULL),
('da', 'dime.actor.type', 'default', 'Type', NULL),
('da', 'dime.actor.type.museum', 'default', 'Museum', NULL),
...
('da', 'module.actor', 'default', 'Aktører', NULL),
...
('en', 'core.message.newmessages', 'default', 'New Notifications', NULL),
...
('en', 'dime.actor.id', 'default', 'Actor ID', NULL),
('en', 'dime.actor.municipalities', 'default', 'Municipalities', NULL),
('en', 'dime.actor.type', 'default', 'Type', NULL),
('en', 'dime.actor.type.institution', 'default', 'dime.actor.type.institution', NULL),
('en', 'dime.actor.type.museum', 'default', 'Museum', NULL),
('en', 'dime.actor.type.person', 'default', 'dime.actor.type.person', NULL),
...
('en', 'format.actor', 'default', 'Actor Format', NULL),
...
('en', 'module.actor', 'default', 'Actor', NULL),
...
('en', 'schema.actor', 'default', 'Actor', NULL),
...
('core_widget_checkbox', 'widget', 1, 0, 'core.widget.send'),
...
('dime_widget_explain', 'widget', 1, 0, 'core.button.save'),
('dime_widget_role', 'widget', 1, 0, 'core.button.save');
...
('core_actor_avatar', 'core.actor', 'actor', 'avatar', 1, NULL, 'active', NULL, NULL, NULL, NULL, ''),
...
('core_actor_visibility', 'core.actor', 'actor', 'visibility', 1, NULL, 'active', NULL, NULL, NULL, NULL, ''),
...
('dime_find_condition', 'dime.find', 'find', 'condition', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:75%\"}}'),
('dime_find_custodian', 'dime.find', 'find', 'custodian', 1, 'fullname', 'readonly', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_custody', 'dime.find', 'find', 'custody', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
...
('dime_find_finder', 'dime.find', 'find', 'finder', 1, 'fullname', 'readonly', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_finder_id', 'dime.find', 'find', 'finder_id', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_id', 'dime.find', 'find', 'id', 1, NULL, 'readonly', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_images', 'dime.find', 'find', 'image', 1, NULL, 'active', NULL, NULL, 'blocks/imagecollection.html.twig', NULL, '{\"multiple\":true}'),
...
('dime_find_process', 'dime.find', 'find', 'process', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_recipient', 'dime.find', 'find', 'recipient', 1, 'fullname', 'readonly', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_recorder', 'dime.find', 'find', 'recorder', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_secondary', 'dime.find', 'find', 'secondary', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"multiple\":true, \"expanded\": \"true\", \"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_treasure', 'dime.find', 'find', 'treasure', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_type', 'dime.find', 'find', 'type', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:75%\"}}'),
('dime_find_visibility', 'dime.find', 'find', 'visibility', 1, NULL, 'active', NULL, NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
('dime_find_weight', 'dime.find', 'find', 'weight', 1, NULL, 'active', 'hidden', NULL, NULL, NULL, '{\"attr\": {\"style\": \"width:50%\"}}'),
...
INSERT INTO `ark_view_grid` (`layout`, `row`, `col`, `seq`, `item_type`, `element`, `map`, `label`, `required`, `mode`, `sanitise`, `value`, `parameter`, `format`, `display`, `data`, `enabled`, `deprecated`, `keyword`, `options`) VALUES
('core_actor_item', 0, 0, 0, '', 'core_actor_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_item', 0, 0, 1, '', 'core_actor_fullname', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_item', 0, 0, 2, '', 'core_actor_shortname', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_item', 0, 0, 3, '', 'core_actor_municipality', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_list', 0, 0, 0, '', 'core_actor_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_list', 0, 0, 1, '', 'core_actor_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_list', 0, 0, 2, '', 'core_actor_fullname', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 0, '', 'core_actor_id', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 2, '', 'core_actor_fullname', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 4, '', 'core_actor_shortname', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 6, '', 'core_actor_initials', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 8, '', 'core_actor_address', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 10, '', 'core_actor_telephone', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 12, '', 'core_actor_email', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 14, '', 'core_actor_visibility', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 16, '', 'core_actor_license', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 18, '', 'core_actor_biography', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_actor_person', 0, 0, 20, '', 'core_actor_avatar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 0, 0, '', 'core_file_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 0, 1, '', 'core_file_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 0, 2, '', 'core_file_mediatype', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 0, 3, '', 'core_file_title', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 0, 4, '', 'core_file_status', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 0, 5, '', 'core_file_description', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_item', 0, 1, 1, '', 'core_widget_save', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_list', 0, 0, 0, '', 'core_file_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_file_list', 0, 0, 1, '', 'core_file_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_item', 0, 0, 0, '', 'core_message_type', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_item', 0, 0, 1, '', 'core_message_sender', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_item', 0, 0, 2, '', 'core_message_sent_at', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_item', 0, 0, 3, '', 'core_message_event', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_list', 0, 0, 0, '', 'core_message_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_list', 0, 0, 1, '', 'core_message_sender', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_list', 0, 0, 2, '', 'core_message_sent_at', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_message_list', 0, 0, 3, '', 'core_message_event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_page_view', 0, 0, 0, '', 'core_page_content', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_user_login', 0, 0, 0, '', '_username', NULL, NULL, 1, 'edit', NULL, 'active', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_user_login', 0, 0, 2, '', '_password', NULL, NULL, 1, 'edit', NULL, 'active', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_user_login', 0, 0, 4, '', 'core_widget_send', NULL, NULL, NULL, 'edit', NULL, 'active', NULL, NULL, NULL, NULL, 1, 0, 'core.user.login', NULL),
('core_user_password', 0, 0, 0, '', '_password', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_user_password', 0, 0, 1, '', '_password', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_user_password', 0, 0, 2, '', '_password', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('core_user_password', 0, 0, 3, '', 'core_widget_send', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_add', 0, 0, 0, '', 'dime_find_event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_add', 0, 1, 0, '', 'dime_find_artefact', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 0, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 2, '', 'dime_find_classification', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 8, '', 'dime_find_dating', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 10, '', 'dime_find_material', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 12, '', 'dime_find_secondary', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 14, '', 'dime_find_condition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 16, '', 'dime_find_weight', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 18, '', 'dime_find_length', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_artefact', 0, 0, 20, '', 'dime_find_description', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_edit', 0, 0, 0, '', 'dime_find_event', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_edit', 0, 1, 0, '', 'dime_find_artefact', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_event', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_event', 0, 0, 2, '', 'dime_find_museum_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_event', 0, 0, 4, '', 'dime_find_finder', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_event', 0, 0, 6, '', 'dime_find_finder_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_event', 0, 0, 8, '', 'dime_find_finddate', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_filter', 0, 0, 0, '', 'dime_find_filter_municipality', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_filter', 0, 1, 0, '', 'dime_find_filter_type', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_filter', 0, 2, 0, '', 'dime_find_filter_period', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_filter', 0, 3, 0, '', 'dime_find_filter_material', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_filter', 0, 4, 0, '', 'core_widget_search', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_geo', 0, 0, 0, '', 'dime_find_location', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_geo', 0, 0, 2, '', 'dime_find_municipality', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_geo', 0, 0, 4, '', 'dime_find_museum', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_item', 0, 0, 0, '', 'dime_find_event', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_item', 0, 0, 2, '', 'dime_find_geo', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_item', 0, 0, 4, '', 'dime_find_photo', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_item', 0, 1, 0, '', 'dime_find_artefact', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_item', 0, 1, 1, '', 'dime_find_status', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_item', 0, 1, 4, '', 'dime_find_apply', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_list', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_list', 0, 0, 1, '', 'dime_find_finder_id', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_list', 0, 0, 2, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_list', 0, 0, 4, '', 'dime_find_material', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_map', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_map', 0, 0, 1, '', 'dime_find_location', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_photo', 0, 0, 1, '', 'dime_find_images', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_search', 0, 0, 0, '', 'dime_find_filter', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_search', 1, 0, 0, '', 'dime_find_list', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_search', 1, 1, 0, '', 'dime_find_map', 'dime_map_public', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 0, '', 'dime_find_process', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 2, '', 'dime_find_treasure', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 4, '', 'dime_find_owner', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 6, '', 'dime_find_custody', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 8, '', 'dime_find_custodian', NULL, NULL, NULL, NULL, NULL, 'static', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 10, '', 'dime_find_recipient', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 12, '', 'dime_find_actions', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_find_status', 0, 0, 14, '', 'core_widget_save', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_front_page', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_front_page', 0, 0, 1, '', 'dime_find_finder_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_front_page', 0, 0, 2, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_front_page', 0, 0, 4, '', 'dime_find_material', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_home_page', 0, 0, 0, '', 'dime_home_action', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_home_page', 1, 0, 0, '', 'dime_find_list', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_home_page', 1, 1, 0, '', 'dime_find_map', 'dime_map_user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_message_page', 0, 0, 0, '', 'core_message_list', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_message_page', 0, 1, 0, '', 'core_message_item', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_profile_page', 0, 0, 0, '', 'dime_home_action', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_profile_page', 1, 0, 0, '', 'core_actor_person', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_profile_page', 1, 1, 0, '', 'core_user_password', NULL, NULL, NULL, 'edit', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_claim', 0, 0, 0, '', 'dime_treasure_museum', NULL, NULL, NULL, 'edit', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_claim', 0, 0, 1, '', 'dime_treasure_claimant', NULL, NULL, NULL, 'edit', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_claim', 0, 0, 2, '', 'dime_treasure_find', NULL, NULL, NULL, 'edit', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_claim', 0, 0, 3, '', 'dime_treasure_sender', NULL, NULL, NULL, 'edit', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_claimant', 0, 0, 1, '', 'core_actor_fullname', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'claimant', 1, 0, NULL, NULL),
('dime_treasure_claimant', 0, 0, 4, '', 'core_actor_telephone', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'claimant', 1, 0, NULL, NULL),
('dime_treasure_claimant', 0, 0, 5, '', 'core_actor_email', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'claimant', 1, 0, NULL, NULL),
('dime_treasure_find', 0, 0, 0, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'find', 1, 0, NULL, NULL),
('dime_treasure_find', 0, 0, 2, '', 'dime_find_classification', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'find', 1, 0, NULL, NULL),
('dime_treasure_find', 0, 0, 4, '', 'dime_find_finddate', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'find', 1, 0, NULL, NULL),
('dime_treasure_find', 0, 0, 8, '', 'dime_find_description', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'find', 1, 0, NULL, NULL),
('dime_treasure_museum', 0, 0, 0, '', 'core_actor_fullname', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'museum', 1, 0, 'dime.actor.type.museum', NULL),
('dime_treasure_museum', 0, 0, 1, '', 'core_actor_id', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'museum', 1, 0, NULL, NULL),
('dime_treasure_museum', 0, 0, 2, '', 'dime_find_museum_id', NULL, NULL, NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 'find', 1, 0, NULL, NULL),
('dime_treasure_pdf', 0, 0, 0, '', 'dime_treasure_museum', NULL, NULL, NULL, 'view', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_pdf', 0, 0, 1, '', 'dime_treasure_claimant', NULL, NULL, NULL, 'view', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_pdf', 0, 0, 2, '', 'dime_treasure_find', NULL, NULL, NULL, 'view', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_pdf', 0, 0, 3, '', 'dime_treasure_sender', NULL, NULL, NULL, 'view', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_treasure_sender', 0, 0, 4, '', 'core_widget_send', NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_user_register', 0, 0, 0, '', 'core_actor_person', NULL, NULL, NULL, NULL, 'redact', NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_user_register', 0, 0, 2, '', 'dime_user_role', NULL, NULL, NULL, NULL, 'redact', NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_user_register', 0, 0, 4, '', 'core_widget_checkbox', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_user_register', 0, 0, 6, '', 'core_widget_send', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_user_register', 0, 1, 0, '', 'dime_user_terms', NULL, NULL, NULL, NULL, 'redact', NULL, NULL, NULL, NULL, NULL, 1, 0, 'dime.user.terms', NULL),
('dime_user_role', 0, 0, 0, '', 'dime_widget_role', NULL, NULL, NULL, NULL, 'redact', NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL),
('dime_user_role', 0, 0, 2, '', 'dime_widget_explain', NULL, NULL, NULL, NULL, 'redact', NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL);
...
('dime_user_role', NULL, NULL, 0, NULL, NULL, NULL, 'edit', NULL);
...
('core_page_user_reset', 'edit', 'public', NULL, NULL, 'dime_site_header', 'dime_site_sidebar', NULL, 'dime_site_footer', NULL),
...
('dime_page_find', 'edit', 'restricted', 'dime.find.read', 'dime.find.update', 'dime_site_header', 'dime_site_sidebar', 'dime_find_item', 'dime_site_footer', NULL),
...
('dime_page_news', 'view', 'public', NULL, NULL, 'dime_site_header', 'dime_site_sidebar', 'dime_find_list', 'dime_site_footer', NULL),
...
('widget', 'ARK\\View\\Widget', 0, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ButtonType', 'layouts/field.html.twig', NULL);
...
CREATE TABLE `ark_view_widget` (
  `element` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mode` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'view',
  `force_name` tinyint(1) NOT NULL DEFAULT '0',
  `label` tinyint(1) NOT NULL DEFAULT '1',
  `vocabulary` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `template` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `form_type_class` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `ark_view_widget` (`element`, `mode`, `force_name`, `label`, `vocabulary`, `template`, `form_type_class`, `form_options`) VALUES
('_password', 'edit', 1, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\PasswordType', ''),
('_username', 'edit', 1, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType', ''),
('core_widget_checkbox', 'edit', 0, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\CheckboxType', ''),
('core_widget_save', 'edit', 0, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType', ''),
('core_widget_search', 'view', 0, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType', ''),
('core_widget_send', 'edit', 0, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType', ''),
('dime_find_actions', 'edit', 0, 1, NULL, NULL, 'ARK\\Form\\Type\\TermChoiceType', ''),
('dime_find_filter_material', 'view', 0, 1, 'dime.material', NULL, 'ARK\\Form\\Type\\TermChoiceType', '{\"multiple\":true}'),
('dime_find_filter_municipality', 'view', 0, 1, 'dime.denmark.municipality', NULL, 'ARK\\Form\\Type\\TermChoiceType', '{\"multiple\":true}'),
('dime_find_filter_period', 'view', 0, 1, 'dime.period', NULL, 'ARK\\Form\\Type\\TermChoiceType', '{\"multiple\":true}'),
('dime_find_filter_type', 'view', 0, 1, 'dime.find.type', NULL, 'ARK\\Form\\Type\\TermChoiceType', '{\"multiple\":true}'),
('dime_widget_explain', 'edit', 1, 1, NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TextareaType', ''),
('dime_widget_role', 'view', 0, 1, 'dime.material', NULL, 'ARK\\Form\\Type\\TermChoiceType', '');
...
('core.form.modus', 'active', '', 0, 1, 0, 'core.form.mode.active', 'Form field is editable.'),
('core.form.modus', 'disabled', '', 0, 1, 0, 'core.form.mode.disabled', 'Form field is Disabled.'),
('core.form.modus', 'excluded', '', 0, 1, 0, 'core.form.mode.excluded', 'Field is excluded from the form.'),
('core.form.modus', 'hidden', '', 0, 1, 0, 'core.form.mode.hidden', 'Form field is Hidden'),
('core.form.modus', 'readonly', '', 0, 1, 0, 'core.form.mode.readonly', 'Form field is Readonly.'),
('core.form.modus', 'static', '', 0, 1, 0, 'core.form.mode.static', 'Field is displayed by not as a form element.'),
...
('core.license', 'cc0', 'CC0', 0, 1, 0, 'core.license.cc0', ''),
('core.license', 'ccbyncsa', 'CC BY-NC-SA', 0, 1, 0, 'core.license.ccbyncsa', ''),
('core.license', 'ccbysa', 'CC BY-SA', 0, 1, 0, 'core.license.ccbysa', ''),
...
('dime.user.terms', 'v1', '', 0, 1, 0, 'dime.user.terms.v1', ''),
...
('anon', 'core.page.read'),
('anon', 'core.user.confirm'),
('anon', 'core.user.login'),
('anon', 'core.user.register'),
...
ALTER TABLE `ark_schema_attribute`
  ...
  ADD CONSTRAINT `schema_attribute_translation` FOREIGN KEY (`keyword`) REFERENCES `ark_translation` (`keyword`) ON UPDATE CASCADE,
