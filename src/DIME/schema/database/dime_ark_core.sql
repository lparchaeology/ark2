...
--
-- Host: localhost
-- Generation Time: May 12, 2017 at 10:53 AM
...
INSERT INTO `ark_format` (`format`, `datatype`, `entity`, `value_name`, `value_form_class`, `parameter_name`, `parameter_vocabulary`, `parameter_form_class`, `format_name`, `format_vocabulary`, `format_form_class`, `form_type_class`, `object`, `array`, `span`, `multiple`, `sortable`, `searchable`, `enabled`, `deprecated`, `keyword`) VALUES
('actor', 'item', 'ARK\\Actor\\Actor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.actor'),
('address', 'object', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 1, 1, 0, 'format.address'),
('blob', 'blob', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.blob'),
('boolean', 'boolean', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.boolean'),
('classification', 'object', NULL, NULL, 'ARK\\Form\\Type\\TermChoiceType', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 1, 1, 0, 'format.address'),
('color', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.colour'),
('date', 'date', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.date'),
('datetime', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.datetime'),
('dating', 'object', NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\IntegerType', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 1, 1, 0, 'format.dating'),
('decimal', 'decimal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.decimal'),
('description', 'object', NULL, NULL, 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TextareaType', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 1, 1, 0, 'format.address'),
...
('money', 'decimal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.money'),
...
('term', 'string', 'ARK\\Vocabulary\\Term', 'term', 'ARK\\Form\\Type\\TermChoiceType', 'concept', NULL, 'ARK\\Form\\Type\\TermChoiceType', NULL, NULL, NULL, 'ARK\\Form\\Type\\VocabularyFormType', 0, 0, 0, 0, 1, 1, 1, 0, 'format.identifier'),
...
('year', 'integer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.year'),
('yearmonth', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.yearmonth'),
('yearspan', 'integer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 0, 1, 1, 1, 0, 'format.yearspan'),
('yearweek', 'string', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 1, 0, 'format.yearweek');
...
('dime.find', 'find', 'finder', 'actor', NULL, 'restricted', 'dime.find.read.finder', 'dime.find.update.finder', 0, 1, 1, 1, 0, 1, 0, 'dime.find.finder'),
...
('dime.find', 'find', 'image', 'file', NULL, 'public', NULL, NULL, 0, 0, 0, 1, 1, 1, 0, 'dime.find.images'),
...
('dime.find', 'find', 'treasure', 'term', 'dime.treasure', 'public', 'dime.find.read.treasure', 'dime.find.update.treasure', 0, 1, 1, 1, 0, 1, 0, 'dime.find.treasure'),
...
('core.message.allmessages', 'dime', 0, 0),
('core.message.messages', 'dime', 0, 0),
...
('da', 'core.message.messages', 'default', 'UNDERRETNINGER', ''),
('da', 'core.message.newmessages', 'default', 'NYE UNDERRETNINGER', ''),
...
('da', 'dime.action.edit', 'default', 'redigere', ''),
...
('da', 'dime.find.custodian', 'default', 'Vogter', ''),
...
('da', 'dime.find.custody.held', 'default', 'holdt', ''),
('da', 'dime.find.custody.lost', 'default', 'Faret Vild', ''),
('da', 'dime.find.custody.requested', 'default', 'anmodet', ''),
('da', 'dime.find.custody.sent', 'default', 'sendt', ''),
...
('da', 'dime.find.event.edited', 'default', 'Redigeret', ''),
('da', 'dime.find.event.reported', 'default', 'Berette', ''),
...
('da', 'dime.find.location', 'default', 'Koordinater', ''),
...
('da', 'dime.find.museum_id', 'default', 'Museum ID', ''),
...
('da', 'dime.find.process', 'default', 'Status', ''),
('da', 'dime.find.process.accessioned', 'default', 'accessioneret', ''),
('da', 'dime.find.process.assessed', 'default', 'vurderes', ''),
('da', 'dime.find.process.deleted', 'default', 'slettet', ''),
('da', 'dime.find.process.evaluated', 'default', 'evalueret', ''),
('da', 'dime.find.process.inactive', 'default', 'inaktiv', ''),
('da', 'dime.find.process.recorded', 'default', 'registreret', ''),
('da', 'dime.find.process.rejected', 'default', 'afvist', ''),
('da', 'dime.find.process.released', 'default', 'udgivet', ''),
('da', 'dime.find.process.reported', 'default', 'rapporteret', ''),
('da', 'dime.find.process.validated', 'default', 'valideret', ''),
('da', 'dime.find.recipient', 'default', 'Modtager', ''),
...
('da', 'dime.map.layer.foraar', 'default', 'Foraar Kortlag', ''),
('da', 'dime.map.layer.skaermkort', 'default', 'Skaermkort', ''),
...
('da', 'map.layer.bing.road', 'default', 'Bing køreplan', ''),
...
('da', 'vocabulary.dime.find.condition', 'default', 'tilstand', ''),
...
('en', 'core.message.newmessages', 'default', 'New Notifications', ''),
...
('en', 'dime.action.edit', 'default', 'edit', ''),
...
('en', 'dime.find.custody.destroyed', 'default', 'destroyed', ''),
('en', 'dime.find.custody.discarded', 'default', 'discarded', ''),
('en', 'dime.find.custody.held', 'default', 'held', ''),
('en', 'dime.find.custody.lost', 'default', 'Lost', ''),
('en', 'dime.find.custody.requested', 'default', 'requested', ''),
('en', 'dime.find.custody.sent', 'default', 'sent', ''),
...
('en', 'dime.find.event.reported', 'default', 'Reported', ''),
...
('en', 'dime.find.museum_id', 'default', 'Museum ID', ''),
...
('en', 'dime.find.process.accessioned', 'default', 'accessioned', ''),
('en', 'dime.find.process.assessed', 'default', 'assessed', ''),
('en', 'dime.find.process.deleted', 'default', 'deleted', ''),
('en', 'dime.find.process.evaluated', 'default', 'evaluated', ''),
('en', 'dime.find.process.inactive', 'default', 'inactive', ''),
('en', 'dime.find.process.recorded', 'default', 'recorded', ''),
('en', 'dime.find.process.rejected', 'default', 'rejected', ''),
('en', 'dime.find.process.released', 'default', 'released', ''),
('en', 'dime.find.process.reported', 'default', 'reported', ''),
('en', 'dime.find.process.validated', 'default', 'validated', ''),
...
('en', 'dime.map.layer.foraar', 'default', 'Foraar Layer', ''),
('en', 'dime.map.layer.skaermkort', 'default', 'Skaermkort', ''),
...
('en', 'vocabulary.dime.find.condition', 'default', 'condition', '');
...
('dime_find_carousel', 'field', '', 'blocks/carouselfield.html.twig', 1, 0, NULL),
...
('dime_find_image', 'field', '', '', 1, 0, NULL),
('dime_find_item', 'grid', '', '', 1, 0, NULL),
('dime_find_length', 'field', '', '', 1, 0, NULL),
('dime_find_list', 'table', '', '', 1, 0, NULL),
('dime_find_location', 'field', '', 'blocks/mappick.html.twig', 1, 0, NULL),
...
('dime_actor_municipality', 'core.actor', 'museum', 'municipality', 1, 'active', NULL, NULL, NULL, ''),
...
('core_file_item', 0, 0, 3, '', 'core_file_title', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_file_item', 0, 0, 4, '', 'core_file_status', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_file_item', 0, 0, 5, '', 'core_file_description', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_file_item', 0, 1, 1, '', 'dime_save', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_file_list', 0, 0, 0, '', 'core_file_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_file_list', 0, 0, 1, '', 'core_file_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_message_item', 0, 0, 0, '', 'core_message_type', NULL, NULL, NULL, 'static', NULL, NULL, NULL, 1, 0, NULL),
('core_message_item', 0, 0, 1, '', 'core_message_sender', NULL, NULL, NULL, 'static', NULL, NULL, NULL, 1, 0, NULL),
('core_message_item', 0, 0, 2, '', 'core_message_sent_at', NULL, NULL, NULL, 'static', NULL, NULL, NULL, 1, 0, NULL),
('core_message_item', 0, 0, 3, '', 'core_message_event', NULL, NULL, NULL, 'static', NULL, NULL, NULL, 1, 0, NULL),
('core_message_list', 0, 0, 0, '', 'core_message_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('core_message_list', 0, 0, 1, '', 'core_message_sender', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_apply', 0, 0, 1, '', 'dime_save', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 0, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 2, '', 'dime_find_classification', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 8, '', 'dime_find_dating', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 10, '', 'dime_find_material', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 12, '', 'dime_find_secondary', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 14, '', 'dime_find_condition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 16, '', 'dime_find_weight', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 18, '', 'dime_find_length', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 20, '', 'dime_find_description', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_edit', 0, 0, 0, '', 'dime_find_event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_edit', 0, 1, 0, '', 'dime_find_details', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 10, '', 'dime_find_finder_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 12, '', 'dime_find_finddate', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 14, '', 'dime_find_location', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 16, '', 'dime_find_municipality', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 18, '', 'dime_find_museum', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 19, '', 'dime_find_museum_id', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 21, '', 'dime_find_process', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 22, '', 'dime_find_treasure', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 24, '', 'dime_find_owner', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 26, '', 'dime_find_custody', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 28, '', 'dime_find_custodian', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 30, '', 'dime_find_recipient', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_filter', 0, 0, 0, '', 'dime_find_filter_municipality', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, NULL),
('dime_find_filter', 0, 1, 0, '', 'dime_find_filter_type', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, NULL),
('dime_find_filter', 0, 2, 0, '', 'dime_find_filter_period', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, NULL),
('dime_find_filter', 0, 3, 0, '', 'dime_find_filter_material', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, NULL),
('dime_find_filter', 0, 4, 0, '', 'dime_search', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_item', 0, 0, 0, '', 'dime_find_event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_item', 0, 0, 1, '', 'dime_find_carousel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_item', 0, 1, 0, '', 'dime_find_details', NULL, 0, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_item', 0, 1, 1, '', 'dime_find_apply', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_list', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_list', 0, 0, 1, '', 'dime_find_finder_id', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_list', 0, 0, 2, '', 'dime_find_type', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_list', 0, 0, 4, '', 'dime_find_material', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_map', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_map', 0, 0, 1, '', 'dime_find_location', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_search', 0, 0, 0, '', 'dime_find_filter', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_search', 1, 0, 0, '', 'dime_find_list', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_search', 1, 1, 0, '', 'dime_find_map', 'dime_map_public', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_visibility', 0, 0, 20, '', 'dime_find_visibility', NULL, NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_front_page', 0, 0, 0, '', 'dime_find_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_front_page', 0, 0, 1, '', 'dime_find_finder_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_front_page', 0, 0, 2, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_front_page', 0, 0, 4, '', 'dime_find_material', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_home_page', 0, 0, 0, '', 'dime_home_action', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
...
INSERT INTO `ark_view_layout` (`element`, `schma`, `item_type`, `form`, `mode`) VALUES
('core_file_item', NULL, NULL, 1, 'edit'),
('core_file_list', NULL, NULL, 0, NULL),
('core_message_item', 'core.message', NULL, 1, 'view'),
('core_message_list', NULL, NULL, 1, 'view'),
('core_page_view', NULL, NULL, 0, NULL),
('dime_actor_item', NULL, NULL, 1, 'edit'),
('dime_actor_list', NULL, NULL, 1, 'view'),
('dime_find_add', NULL, NULL, 0, NULL),
('dime_find_apply', NULL, NULL, 0, NULL),
('dime_find_details', NULL, NULL, 0, NULL),
('dime_find_edit', NULL, NULL, 0, NULL),
('dime_find_event', NULL, NULL, 0, NULL),
('dime_find_filter', NULL, NULL, 1, 'edit'),
('dime_find_item', NULL, NULL, 1, 'edit'),
('dime_find_list', NULL, NULL, 1, 'view'),
('dime_find_map', NULL, NULL, 0, NULL),
('dime_find_search', NULL, NULL, 0, NULL),
('dime_front_page', 'dime.find', NULL, 0, NULL),
('dime_home_action', NULL, NULL, 0, NULL),
('dime_home_page', NULL, NULL, 0, NULL),
('dime_message_page', NULL, NULL, 0, NULL);
...
('dime_page_find_list', 'view', 'dime_find_search', NULL, NULL, 'dime_nav_sidebar', NULL),
('dime_page_front', 'view', 'dime_front_page', NULL, NULL, 'dime_nav_sidebar', NULL),
('dime_page_home', 'view', 'dime_home_page', NULL, NULL, 'dime_nav_sidebar', NULL),
('dime_page_message', 'view', 'dime_message_page', NULL, NULL, 'dime_nav_sidebar', NULL),
('dime_page_news', 'view', 'dime_find_list', NULL, NULL, 'dime_nav_sidebar', NULL),
('dime_page_static', 'view', NULL, NULL, NULL, 'dime_nav_sidebar', NULL);
...
('core.event.type', 'accessioned', '', 0, 0, 0, 'dime.find.event.accessioned', ''),
('core.event.type', 'activated', '', 0, 0, 0, 'core.actor.event.activated', ''),
('core.event.type', 'agreed', '', 0, 0, 0, 'dime.find.event.agreed', ''),
('core.event.type', 'annotated', '', 0, 0, 0, 'dime.find.event.annotated', ''),
('core.event.type', 'appraised', '', 0, 0, 0, 'dime.find.event.appraised', ''),
('core.event.type', 'approved', '', 0, 0, 0, 'core.actor.event.approved', ''),
('core.event.type', 'assessed', '', 0, 0, 0, 'dime.find.event.assessed', ''),
('core.event.type', 'cancelled', '', 0, 0, 0, 'core.actor.event.cancelled', ''),
('core.event.type', 'cited', '', 0, 0, 0, 'dime.find.event.cited', ''),
('core.event.type', 'classified', '', 0, 0, 0, 'dime.find.event.classified', ''),
('core.event.type', 'commented', '', 0, 0, 0, 'dime.find.event.commented', ''),
('core.event.type', 'conserved', '', 0, 0, 0, 'dime.find.event.conserved', ''),
('core.event.type', 'contacted', '', 0, 0, 0, 'dime.find.event.contacted', ''),
('core.event.type', 'dated', '', 0, 0, 0, 'dime.find.event.dated', ''),
('core.event.type', 'declined', '', 0, 0, 0, 'dime.find.event.declined', ''),
('core.event.type', 'deleted', '', 0, 0, 0, 'dime.find.event.deleted', ''),
('core.event.type', 'described', '', 0, 0, 0, 'dime.find.event.described', ''),
('core.event.type', 'destroyed', '', 0, 0, 0, 'dime.find.event.destroyed', ''),
('core.event.type', 'disagreed', '', 0, 0, 0, 'dime.find.event.disagreed', ''),
('core.event.type', 'discarded', '', 0, 0, 0, 'dime.find.event.discarded', ''),
('core.event.type', 'edited', '', 0, 0, 0, 'dime.find.event.edited', ''),
('core.event.type', 'evaluated', '', 0, 0, 0, 'dime.find.event.evaluated', ''),
('core.event.type', 'exported', '', 0, 0, 0, 'dime.find.event.exported', ''),
('core.event.type', 'followed', '', 0, 0, 0, 'dime.find.event.followed', ''),
('core.event.type', 'identified', '', 0, 0, 0, 'dime.find.event.identified', ''),
('core.event.type', 'liked', '', 0, 0, 0, 'dime.find.event.liked', ''),
('core.event.type', 'loaned', '', 0, 0, 0, 'dime.find.event.loaned', ''),
('core.event.type', 'lost', '', 0, 0, 0, 'dime.find.event.lost', ''),
('core.event.type', 'notified', '', 0, 0, 0, 'dime.find.event.notified', ''),
('core.event.type', 'published', '', 0, 0, 0, 'dime.find.event.published', ''),
('core.event.type', 'received', '', 0, 0, 0, 'dime.find.event.received', ''),
('core.event.type', 'recorded', '', 0, 0, 0, 'dime.find.event.recorded', ''),
('core.event.type', 'recovered', '', 0, 0, 0, 'dime.find.event.recovered', ''),
('core.event.type', 'redacted', '', 0, 0, 0, 'dime.find.event.redacted', ''),
('core.event.type', 'referred', '', 0, 0, 0, 'dime.find.event.referred', ''),
('core.event.type', 'registered', '', 0, 0, 0, 'core.actor.event.registered', ''),
('core.event.type', 'rejected', '', 0, 0, 0, 'dime.find.event.rejected', ''),
('core.event.type', 'released', '', 0, 0, 0, 'dime.find.event.released', ''),
('core.event.type', 'reported', '', 0, 0, 0, 'dime.find.event.reported', ''),
('core.event.type', 'requested', '', 0, 0, 0, 'dime.find.event.requested', ''),
('core.event.type', 'restored', '', 0, 0, 0, 'core.actor.event.restored', ''),
('core.event.type', 'rewarded', '', 0, 0, 0, 'dime.find.event.rewarded', ''),
('core.event.type', 'sent', '', 0, 0, 0, 'dime.find.event.sent', ''),
('core.event.type', 'shared', '', 0, 0, 0, 'dime.find.event.shared', ''),
('core.event.type', 'subscribed', '', 0, 0, 0, 'dime.find.event.subscribed', ''),
('core.event.type', 'suppressed', '', 0, 0, 0, 'dime.find.event.suppressed', ''),
...
('core.license', 'cc0', 'CC0', 0, 1, 0, 'core.file.license.cc0', ''),
('core.license', 'ccbyncsa', 'CC BY-NC-SA', 0, 1, 0, 'core.file.license.ccbyncsa', ''),
('core.license', 'ccbysa', 'CC BY-SA', 0, 1, 0, 'core.file.license.ccbysa', ''),
('core.message.recipient.status', 'discarded', '', 0, 1, 0, 'core.message.recipient.status.discarded', ''),
('core.message.recipient.status', 'read', '', 0, 1, 0, 'core.message.recipient.status.read', ''),
('core.message.recipient.status', 'unread', '', 0, 1, 0, 'core.message.recipient.status.unread', ''),
...
('dime.denmark.municipality', '101', 'kobenhavn', 0, 1, 0, 'dime.kommune.kobenhavn', ''),
('dime.denmark.municipality', '147', 'frederiksbeg', 0, 1, 0, 'dime.kommune.frederiksbeg', ''),
('dime.denmark.municipality', '151', 'ballerup', 0, 1, 0, 'dime.kommune.ballerup', ''),
('dime.denmark.municipality', '153', 'brondby', 0, 1, 0, 'dime.kommune.brondby', ''),
('dime.denmark.municipality', '155', 'dragor', 0, 1, 0, 'dime.kommune.dragor', ''),
('dime.denmark.municipality', '157', 'gentofte', 0, 1, 0, 'dime.kommune.gentofte', ''),
('dime.denmark.municipality', '159', 'gladsaxe', 0, 1, 0, 'dime.kommune.gladsaxe', ''),
('dime.denmark.municipality', '161', 'glostrup', 0, 1, 0, 'dime.kommune.glostrup', ''),
('dime.denmark.municipality', '163', 'herlev', 0, 1, 0, 'dime.kommune.herlev', ''),
('dime.denmark.municipality', '165', 'albertslund', 0, 1, 0, 'dime.kommune.albertslund', ''),
('dime.denmark.municipality', '167', 'hvidovre', 0, 1, 0, 'dime.kommune.hvidovre', ''),
('dime.denmark.municipality', '169', 'hojetaastrup', 0, 1, 0, 'dime.kommune.hojetaastrup', ''),
('dime.denmark.municipality', '173', 'lyngbytaarbaek', 0, 1, 0, 'dime.kommune.lyngbytaarbaek', ''),
('dime.denmark.municipality', '175', 'rodovre', 0, 1, 0, 'dime.kommune.rodovre', ''),
('dime.denmark.municipality', '183', 'ishoj', 0, 1, 0, 'dime.kommune.ishoj', ''),
('dime.denmark.municipality', '185', 'tarnby', 0, 1, 0, 'dime.kommune.tarnby', ''),
('dime.denmark.municipality', '187', 'vallensbaek', 0, 1, 0, 'dime.kommune.vallensbaek', ''),
('dime.denmark.municipality', '190', 'fureso', 0, 1, 0, 'dime.kommune.fureso', ''),
('dime.denmark.municipality', '201', 'allerod', 0, 1, 0, 'dime.kommune.allerod', ''),
('dime.denmark.municipality', '210', 'fredensborg', 0, 1, 0, 'dime.kommune.fredensborg', ''),
('dime.denmark.municipality', '217', 'helsingor', 0, 1, 0, 'dime.kommune.helsingor', ''),
('dime.denmark.municipality', '219', 'hillerod', 0, 1, 0, 'dime.kommune.hillerod', ''),
('dime.denmark.municipality', '223', 'horsholm', 0, 1, 0, 'dime.kommune.horsholm', ''),
('dime.denmark.municipality', '230', 'rudersdal', 0, 1, 0, 'dime.kommune.rudersdal', ''),
('dime.denmark.municipality', '240', 'egedal', 0, 1, 0, 'dime.kommune.egedal', ''),
('dime.denmark.municipality', '250', 'frederikssund', 0, 1, 0, 'dime.kommune.frederikssund', ''),
('dime.denmark.municipality', '253', 'greve', 0, 1, 0, 'dime.kommune.greve', ''),
('dime.denmark.municipality', '259', 'koge', 0, 1, 0, 'dime.kommune.koge', ''),
('dime.denmark.municipality', '260', 'halsnaes', 0, 1, 0, 'dime.kommune.halsnaes', ''),
('dime.denmark.municipality', '265', 'roskilde', 0, 1, 0, 'dime.kommune.roskilde', ''),
('dime.denmark.municipality', '269', 'solrod', 0, 1, 0, 'dime.kommune.solrod', ''),
('dime.denmark.municipality', '270', 'gribskov', 0, 1, 0, 'dime.kommune.gribskov', ''),
('dime.denmark.municipality', '306', 'odsherred', 0, 1, 0, 'dime.kommune.odsherred', ''),
('dime.denmark.municipality', '316', 'holbaek', 0, 1, 0, 'dime.kommune.holbaek', ''),
('dime.denmark.municipality', '320', 'faxe', 0, 1, 0, 'dime.kommune.faxe', ''),
('dime.denmark.municipality', '326', 'kalundborg', 0, 1, 0, 'dime.kommune.kalundborg', ''),
('dime.denmark.municipality', '329', 'ringsted', 0, 1, 0, 'dime.kommune.ringsted', ''),
('dime.denmark.municipality', '330', 'slagelse', 0, 1, 0, 'dime.kommune.slagelse', ''),
('dime.denmark.municipality', '336', 'stevns', 0, 1, 0, 'dime.kommune.stevns', ''),
('dime.denmark.municipality', '340', 'soro', 0, 1, 0, 'dime.kommune.soro', ''),
('dime.denmark.municipality', '350', 'lejre', 0, 1, 0, 'dime.kommune.lejre', ''),
('dime.denmark.municipality', '360', 'lolland', 0, 1, 0, 'dime.kommune.lolland', ''),
('dime.denmark.municipality', '370', 'naestved', 0, 1, 0, 'dime.kommune.naestved', ''),
('dime.denmark.municipality', '376', 'guldborgsund', 0, 1, 0, 'dime.kommune.guldborgsund', ''),
('dime.denmark.municipality', '390', 'vordingborg', 0, 1, 0, 'dime.kommune.vordingborg', ''),
('dime.denmark.municipality', '400', 'bornholm', 0, 1, 0, 'dime.kommune.bornholm', ''),
('dime.denmark.municipality', '410', 'middelfart', 0, 1, 0, 'dime.kommune.middelfart', ''),
('dime.denmark.municipality', '420', 'assens', 0, 1, 0, 'dime.kommune.assens', ''),
('dime.denmark.municipality', '430', 'faaborgmidtfyn', 0, 1, 0, 'dime.kommune.faaborgmidtfyn', ''),
('dime.denmark.municipality', '440', 'kerteminde', 0, 1, 0, 'dime.kommune.kerteminde', ''),
('dime.denmark.municipality', '450', 'nyborg', 0, 1, 0, 'dime.kommune.nyborg', ''),
('dime.denmark.municipality', '461', 'odense', 0, 1, 0, 'dime.kommune.odense', ''),
('dime.denmark.municipality', '479', 'svendborg', 0, 1, 0, 'dime.kommune.svendborg', ''),
('dime.denmark.municipality', '480', 'nordfyns', 0, 1, 0, 'dime.kommune.nordfyns', ''),
('dime.denmark.municipality', '482', 'langeland', 0, 1, 0, 'dime.kommune.langeland', ''),
('dime.denmark.municipality', '492', 'aero', 0, 1, 0, 'dime.kommune.aero', ''),
('dime.denmark.municipality', '510', 'haderslev', 0, 1, 0, 'dime.kommune.haderslev', ''),
('dime.denmark.municipality', '530', 'billund', 0, 1, 0, 'dime.kommune.billund', ''),
('dime.denmark.municipality', '540', 'sonderborg', 0, 1, 0, 'dime.kommune.sonderborg', ''),
('dime.denmark.municipality', '550', 'tonder', 0, 1, 0, 'dime.kommune.tonder', ''),
('dime.denmark.municipality', '561', 'esbjerg', 0, 1, 0, 'dime.kommune.esbjerg', ''),
('dime.denmark.municipality', '563', 'fano', 0, 1, 0, 'dime.kommune.fano', ''),
('dime.denmark.municipality', '573', 'varde', 0, 1, 0, 'dime.kommune.varde', ''),
('dime.denmark.municipality', '575', 'vejen', 0, 1, 0, 'dime.kommune.vejen', ''),
('dime.denmark.municipality', '580', 'aabenraa', 0, 1, 0, 'dime.kommune.aabenraa', ''),
('dime.denmark.municipality', '607', 'fredericia', 0, 1, 0, 'dime.kommune.fredericia', ''),
('dime.denmark.municipality', '615', 'horsens', 0, 1, 0, 'dime.kommune.horsens', ''),
('dime.denmark.municipality', '621', 'kolding', 0, 1, 0, 'dime.kommune.kolding', ''),
('dime.denmark.municipality', '630', 'vejle', 0, 1, 0, 'dime.kommune.vejle', ''),
('dime.denmark.municipality', '657', 'herning', 0, 1, 0, 'dime.kommune.herning', ''),
('dime.denmark.municipality', '661', 'holstebro', 0, 1, 0, 'dime.kommune.holstebro', ''),
('dime.denmark.municipality', '665', 'lemvig', 0, 1, 0, 'dime.kommune.lemvig', ''),
('dime.denmark.municipality', '671', 'struer', 0, 1, 0, 'dime.kommune.struer', ''),
('dime.denmark.municipality', '706', 'syddjurs', 0, 1, 0, 'dime.kommune.syddjurs', ''),
('dime.denmark.municipality', '707', 'norddjurs', 0, 1, 0, 'dime.kommune.norddjurs', ''),
('dime.denmark.municipality', '710', 'favrskov', 0, 1, 0, 'dime.kommune.favrskov', ''),
('dime.denmark.municipality', '727', 'odder', 0, 1, 0, 'dime.kommune.odder', ''),
('dime.denmark.municipality', '730', 'randers', 0, 1, 0, 'dime.kommune.randers', ''),
('dime.denmark.municipality', '740', 'silkeborg', 0, 1, 0, 'dime.kommune.silkeborg', ''),
('dime.denmark.municipality', '741', 'samso', 0, 1, 0, 'dime.kommune.samso', ''),
('dime.denmark.municipality', '746', 'skanderborg', 0, 1, 0, 'dime.kommune.skanderborg', ''),
('dime.denmark.municipality', '751', 'arhus', 0, 1, 0, 'dime.kommune.arhus', ''),
('dime.denmark.municipality', '756', 'ikastbrande', 0, 1, 0, 'dime.kommune.ikastbrande', ''),
('dime.denmark.municipality', '760', 'ringkobingskjern', 0, 1, 0, 'dime.kommune.ringkobingskjern', ''),
('dime.denmark.municipality', '766', 'hedensted', 0, 1, 0, 'dime.kommune.hedensted', ''),
('dime.denmark.municipality', '773', 'morso', 0, 1, 0, 'dime.kommune.morso', ''),
('dime.denmark.municipality', '779', 'skive', 0, 1, 0, 'dime.kommune.skive', ''),
('dime.denmark.municipality', '787', 'thisted', 0, 1, 0, 'dime.kommune.thisted', ''),
('dime.denmark.municipality', '791', 'viborg', 0, 1, 0, 'dime.kommune.viborg', ''),
('dime.denmark.municipality', '810', 'bronderslev', 0, 1, 0, 'dime.kommune.bronderslev', ''),
('dime.denmark.municipality', '813', 'frederikshavn', 0, 1, 0, 'dime.kommune.frederikshavn', ''),
('dime.denmark.municipality', '820', 'vesthimmerland', 0, 1, 0, 'dime.kommune.vesthimmerland', ''),
('dime.denmark.municipality', '825', 'laeso', 0, 1, 0, 'dime.kommune.laeso', ''),
('dime.denmark.municipality', '840', 'rebild', 0, 1, 0, 'dime.kommune.rebild', ''),
('dime.denmark.municipality', '846', 'mariagerfjord', 0, 1, 0, 'dime.kommune.mariagerfjord', ''),
('dime.denmark.municipality', '849', 'jammerbugt', 0, 1, 0, 'dime.kommune.jammerbugt', ''),
('dime.denmark.municipality', '851', 'aalborg', 0, 1, 0, 'dime.kommune.aalborg', ''),
('dime.denmark.municipality', '860', 'hjorring', 0, 1, 0, 'dime.kommune.hjorring', ''),
...
('dime.find.type', 'metal', '', 0, 1, 0, 'dime.find.type.metal', ''),
...
('mediatype', 'image/jpeg', 'jpeg', 0, 1, 0, 'mediatype.image.jpeg', ''),
('mediatype', 'image/png', 'png', 0, 1, 0, 'mediatype.image.png', ''),
('mediatype', 'text/html', 'html', 0, 1, 0, 'mediatype.text.html', ''),
...
('da', 'vocabulary', 'dime.find.type.metal', 'default', 'Produktionsaffald / Metalskrot', ''),
...
('en', 'vocabulary', 'dime.find.type.metal', 'default', 'Production Waste / Scrap Metal', ''),
...
('core.actor', 'activate', 'core.event.type', 'activated', NULL, 0, 0, 0, 0, 1, 'dime.action.activate'),
('core.actor', 'approve', 'core.event.type', 'approved', NULL, 0, 0, 0, 0, 1, 'dime.action.approve'),
('core.actor', 'cancel', 'core.event.type', 'cancelled', NULL, 0, 0, 0, 0, 1, 'dime.action.cancel'),
('core.actor', 'register', 'core.event.type', 'registered', 'registrar', 0, 0, 0, 0, 1, 'dime.action.register'),
('core.actor', 'restore', 'core.event.type', 'restored', NULL, 0, 0, 0, 0, 1, 'dime.action.restore'),
('core.actor', 'suspend', 'core.event.type', 'suspended', NULL, 0, 0, 0, 0, 1, 'dime.action.suspend'),
