...
('dime.treasure', 'assessing', 'dime.treasure', 'not', 'transition', 0),
('dime.treasure', 'assessing', 'dime.treasure', 'treasure', 'transition', 0),
('dime.treasure', 'pending', 'dime.treasure', 'assessing', 'transition', 0);
