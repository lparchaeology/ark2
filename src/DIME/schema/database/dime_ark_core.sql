...
('da', 'dime.find.finderid', 'default', 'Fund Nummer / ID', ''),
...
('da', 'dime.find.period.start', 'default', 'Periode Start', ''),
...
('dime_find_details', 0, 0, 6, '', 1, 0, 'dime_find_condition'),
('dime_find_details', 0, 0, 7, '', 1, 0, 'dime_find_weight'),
('dime_find_details', 0, 0, 8, '', 1, 0, 'dime_find_length'),
