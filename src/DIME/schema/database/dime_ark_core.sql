...
--
-- Host: localhost
-- Generation Time: May 10, 2017 at 10:27 PM
...
('da', 'dime.map.layer.foraar', 'default', 'Foraar Layer', ''),
...
('en', 'map.layer.bing.aerial', 'default', 'Bing luftfotoBing Aerial', ''),
('en', 'map.layer.bing.aerialwithlabels', 'default', 'Luftfoto med etiketterAerial View with Labels', ''),
...
('dime.find', 'edit', 'core.event.type', 'edited', NULL, 0, 1, 1, 0, 1, 'dime.action.edit'),
