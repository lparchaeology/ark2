...
--
-- Host: localhost
-- Generation Time: May 02, 2017 at 10:59 PM
...
('classification', 'object', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 1, 1, 0, 'format.address'),
...
('file', 'item', 'ARK\\File\\File', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.file'),
...
('image', 'item', 'ARK\\File\\Image', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, 0, 'format.image'),
...
('core.file', 'file', 'license', 'term', 'core.file.license', 'public', NULL, NULL, 0, 1, 1, 1, 0, 1, 0, 'core.file.status'),
...
('dime.find', 'find', 'dating', 'dating', NULL, 'public', NULL, NULL, 0, 0, 0, 1, 0, 1, 0, 'property.datings'),
...
('dime.find', 'find', 'images', 'image', NULL, 'public', NULL, NULL, 0, 1, 0, 1, 1, 1, 0, 'dime.find.images'),
...
('dime.find', 'find', 'weight', 'mass', NULL, 'public', NULL, NULL, 0, 0, 1, 1, 0, 1, 0, 'property.weight');
...
('dime_find_classifications', 'field', '', '', 1, 0, NULL),
('dime_find_condition', 'field', '', '', 1, 0, NULL),
('dime_find_custodian', 'field', '', '', 1, 0, NULL),
('dime_find_custody', 'field', '', '', 1, 0, NULL),
('dime_find_datings', 'field', '', '', 1, 0, NULL),
('dime_find_descriptions', 'field', '', '', 1, 0, NULL),
...
('dime_find_images', 'field', '', 'blocks/carouselfield.html.twig', 1, 0, NULL),
...
('dime_find_classifications', 'dime.find', 'find', 'classification', 1, 'active', NULL, NULL, 'DIME\\Form\\Type\\ClassificationType', ''),
('dime_find_condition', 'dime.find', 'find', 'condition', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_custodian', 'dime.find', 'find', 'custodian', 1, 'hidden', 'hidden', NULL, NULL, '{\"display_property\": \"fullname\"}'),
('dime_find_custody', 'dime.find', 'find', 'custody', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_datings', 'dime.find', 'find', 'dating', 1, 'active', NULL, NULL, 'DIME\\Form\\Type\\DatingType', ''),
('dime_find_descriptions', 'dime.find', 'find', 'description', 1, 'active', NULL, NULL, 'DIME\\Form\\Type\\DescriptionType', ''),
('dime_find_finddate', 'dime.find', 'find', 'finddate', 1, 'active', NULL, NULL, NULL, '{\"widget\": \"picker\"}'),
('dime_find_finder', 'dime.find', 'find', 'finder', 1, 'active', NULL, NULL, NULL, '{\"display_property\": \"fullname\"}'),
...
('dime_find_images', 'dime.find', 'find', 'images', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_length', 'dime.find', 'find', 'length', 1, 'active', 'hidden', NULL, NULL, ''),
('dime_find_location', 'dime.find', 'find', 'location', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_material', 'dime.find', 'find', 'material', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_municipality', 'dime.find', 'find', 'municipality', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_museum', 'dime.find', 'find', 'museum', 1, 'active', NULL, NULL, NULL, '{\"display_property\": \"fullname\"}'),
('dime_find_museum_id', 'dime.find', 'find', 'museum_id', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_owner', 'dime.find', 'find', 'owner', 1, 'active', NULL, NULL, NULL, '{\"display_property\": \"fullname\"}'),
('dime_find_process', 'dime.find', 'find', 'process', 1, 'active', NULL, NULL, NULL, ''),
('dime_find_recipient', 'dime.find', 'find', 'recipient', 1, 'active', NULL, NULL, NULL, '{\"display_property\": \"fullname\"}'),
('dime_find_recorder', 'dime.find', 'find', 'recorder', 1, 'active', NULL, NULL, NULL, ''),
...
('dime_find_visibility', 'dime.find', 'find', 'visibility', 1, 'active', NULL, NULL, NULL, ''),
...
('dime_actor_item', 0, 0, 3, '', 'dime_actor_municipality', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_apply', 0, 0, 0, '', 'dime_find_actions', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_apply', 0, 0, 1, '', 'dime_save', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 0, '', 'dime_find_type', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 2, '', 'dime_find_classifications', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 8, '', 'dime_find_datings', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 10, '', 'dime_find_material', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_details', 0, 0, 12, '', 'dime_find_secondary', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_details', 0, 0, 20, '', 'dime_find_descriptions', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_event', 0, 0, 10, '', 'dime_find_finder_id', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 12, '', 'dime_find_finddate', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 14, '', 'dime_find_location', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 16, '', 'dime_find_municipality', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 18, '', 'dime_find_museum', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 19, '', 'dime_find_museum_id', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 21, '', 'dime_find_process', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 22, '', 'dime_find_treasure', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
('dime_find_event', 0, 0, 24, '', 'dime_find_owner', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_item', 0, 0, 1, '', 'dime_find_images', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_item', 0, 1, 0, '', 'dime_find_details', NULL, 0, NULL, NULL, NULL, NULL, 1, 0, NULL),
('dime_find_item', 0, 1, 1, '', 'dime_find_apply', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_map', 0, 0, 1, '', 'dime_find_location', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_visibility', 0, 0, 20, '', 'dime_find_visibility', NULL, NULL, 'readonly', NULL, NULL, NULL, 1, 0, NULL),
...
('dime_find_apply', NULL, NULL, NULL),
...
('core.actor', 'activate', 'core.event.type', 'activated', NULL, 0, 0, 0, 1, 'dime.action.activate'),
('core.actor', 'approve', 'core.event.type', 'approved', NULL, 0, 0, 0, 1, 'dime.action.approve'),
('core.actor', 'cancel', 'core.event.type', 'cancelled', NULL, 0, 0, 0, 1, 'dime.action.cancel'),
('core.actor', 'register', 'core.event.type', 'registered', 'registrar', 0, 0, 0, 1, 'dime.action.register'),
('core.actor', 'restore', 'core.event.type', 'restored', NULL, 0, 0, 0, 1, 'dime.action.restore'),
('core.actor', 'suspend', 'core.event.type', 'suspended', NULL, 0, 0, 0, 1, 'dime.action.suspend'),
('dime.find', 'accession', 'core.event.type', 'accessioned', NULL, 0, 0, 0, 1, 'dime.action.accession'),
('dime.find', 'agree', 'core.event.type', 'agreed', NULL, 0, 0, 0, 1, 'dime.action.agree'),
('dime.find', 'annotate', 'core.event.type', 'annotated', NULL, 0, 0, 0, 1, 'dime.action.annotate'),
('dime.find', 'appraise', 'core.event.type', 'appraised', 'appraiser', 0, 0, 0, 1, 'dime.action.appraise'),
('dime.find', 'assess', 'core.event.type', 'assessed', 'assessor', 0, 0, 0, 1, 'dime.action.assess'),
('dime.find', 'cite', 'core.event.type', 'cited', NULL, 0, 0, 0, 1, 'dime.action.cite'),
('dime.find', 'classify', 'core.event.type', 'classified', '', 0, 0, 0, 1, 'dime.action.classify'),
('dime.find', 'comment', 'core.event.type', 'commented', NULL, 0, 0, 0, 1, 'dime.action.comment'),
('dime.find', 'conserve', 'core.event.type', 'conserved', NULL, 0, 0, 0, 1, 'dime.action.conserve'),
('dime.find', 'contact', 'core.event.type', 'contacted', NULL, 0, 0, 0, 1, 'dime.action.contact'),
('dime.find', 'date', 'core.event.type', 'dated', NULL, 0, 0, 0, 1, 'dime.action.date'),
('dime.find', 'decline', 'core.event.type', 'declined', NULL, 0, 0, 0, 1, 'dime.action.decline'),
('dime.find', 'delete', 'core.event.type', 'deleted', NULL, 0, 0, 0, 1, 'dime.action.delete'),
('dime.find', 'describe', 'core.event.type', 'described', '', 0, 0, 0, 1, 'dime.action.describe'),
('dime.find', 'destroy', 'core.event.type', 'destroyed', NULL, 0, 0, 0, 1, 'dime.action.destroy'),
('dime.find', 'disagree', 'core.event.type', 'disagreed', NULL, 0, 0, 0, 1, 'dime.action.disagree'),
('dime.find', 'discard', 'core.event.type', 'discarded', NULL, 0, 0, 0, 1, 'dime.action.discard'),
('dime.find', 'edit', 'core.event.type', 'edited', NULL, 0, 1, 1, 1, 'dime.action.edit'),
('dime.find', 'evaluate', 'core.event.type', 'evaluated', NULL, 0, 0, 0, 1, 'dime.action.evaluate'),
('dime.find', 'export', 'core.event.type', 'exported', NULL, 0, 0, 0, 1, 'dime.action.export'),
('dime.find', 'follow', 'core.event.type', 'followed', NULL, 0, 0, 0, 1, 'dime.action.follow'),
('dime.find', 'identify', 'core.event.type', 'identified', NULL, 0, 0, 0, 1, 'dime.action.identify'),
('dime.find', 'like', 'core.event.type', 'liked', NULL, 0, 0, 0, 1, 'dime.action.like'),
('dime.find', 'loan', 'core.event.type', 'loaned', NULL, 0, 0, 0, 1, 'dime.action.loan'),
('dime.find', 'lose', 'core.event.type', 'lost', NULL, 0, 0, 0, 1, 'dime.action.lose'),
('dime.find', 'notify', 'core.event.type', 'notified', NULL, 0, 0, 0, 1, 'dime.action.notify'),
('dime.find', 'publish', 'core.event.type', 'published', NULL, 0, 0, 0, 1, 'dime.action.publish'),
('dime.find', 'receive', 'core.event.type', 'received', NULL, 0, 0, 0, 1, 'dime.action.receive'),
('dime.find', 'record', 'core.event.type', 'recorded', 'recorder', 1, 1, 1, 1, 'dime.action.record'),
('dime.find', 'recover', 'core.event.type', 'recovered', NULL, 0, 0, 0, 1, 'dime.action.recover'),
('dime.find', 'redact', 'core.event.type', 'redacted', NULL, 0, 0, 0, 1, 'dime.action.redact'),
('dime.find', 'refer', 'core.event.type', 'referred', NULL, 0, 0, 0, 1, 'dime.action.refer'),
('dime.find', 'reject', 'core.event.type', 'rejected', NULL, 0, 0, 0, 1, 'dime.action.reject'),
('dime.find', 'release', 'core.event.type', 'released', NULL, 0, 0, 0, 1, 'dime.action.release'),
('dime.find', 'report', 'core.event.type', 'reported', 'reporter', 1, 0, 0, 1, 'dime.action.report'),
('dime.find', 'request', 'core.event.type', 'requested', NULL, 0, 0, 0, 1, 'dime.action.request'),
('dime.find', 'reward', 'core.event.type', 'rewarded', NULL, 0, 0, 0, 1, 'dime.action.reward'),
('dime.find', 'send', 'core.event.type', 'sent', NULL, 0, 0, 0, 1, 'dime.action.send'),
('dime.find', 'share', 'core.event.type', 'shared', NULL, 0, 0, 0, 1, 'dime.action.share'),
('dime.find', 'subscribe', 'core.event.type', 'subscribed', NULL, 0, 0, 0, 1, 'dime.action.subscribe'),
('dime.find', 'suppress', 'core.event.type', 'suppressed', NULL, 0, 0, 0, 1, 'dime.action.suppress'),
('dime.find', 'transfer', 'core.event.type', 'transferred', NULL, 0, 0, 0, 1, 'dime.action.transfer'),
('dime.find', 'validate', 'core.event.type', 'validated', NULL, 0, 0, 0, 1, 'dime.action.validate'),
('dime.find', 'withdraw', 'core.event.type', 'withdrawn', NULL, 0, 0, 0, 1, 'dime.action.withdraw');
