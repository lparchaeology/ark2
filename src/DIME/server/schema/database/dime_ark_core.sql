...
--
-- Host: localhost
-- Generation Time: Jan 25, 2018 at 11:50 PM
...
('dime.find.class.accessory', 'vocabulary', 0, 0),
('dime.find.class.coin', 'vocabulary', 0, 0),
('dime.find.class.fibula', 'vocabulary', 0, 0),
('dime.find.class.metal', 'vocabulary', 0, 0),
('dime.find.class.military', 'vocabulary', 0, 0),
('dime.find.class.tool', 'vocabulary', 0, 0),
('dime.find.class.unassessed', 'dime', 0, 0),
('dime.find.class.unknown', 'vocabulary', 0, 0),
...
('core.event.class', 'list', 'ARK Core', 'ARK\\Event', 'Event', 1, 0, 1, 0, 'core.event.class', 'Core Event'),
...
('core.event.class', 'accessioned', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.accessioned', ''),
('core.event.class', 'activated', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.actor.event.activated', ''),
('core.event.class', 'appraised', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.appraised', ''),
('core.event.class', 'approved', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.actor.event.approved', ''),
('core.event.class', 'cancelled', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.actor.event.cancelled', ''),
('core.event.class', 'claimed', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.claimed', ''),
('core.event.class', 'conserved', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.conserved', ''),
('core.event.class', 'declined', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.declined', ''),
('core.event.class', 'deleted', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.deleted', ''),
('core.event.class', 'destroyed', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.destroyed', ''),
('core.event.class', 'discarded', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.discarded', ''),
('core.event.class', 'edited', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.event.edited', ''),
('core.event.class', 'evaluated', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.evaluated', ''),
('core.event.class', 'event', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.event.class', ''),
('core.event.class', 'loaned', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.loaned', ''),
('core.event.class', 'locked', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.user', ''),
('core.event.class', 'lost', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.lost', ''),
('core.event.class', 'published', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.published', ''),
('core.event.class', 'received', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.received', ''),
('core.event.class', 'recorded', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.recorded', ''),
('core.event.class', 'recovered', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.recovered', ''),
('core.event.class', 'registered', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.actor.event.registered', ''),
('core.event.class', 'rejected', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.rejected', ''),
('core.event.class', 'released', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.released', ''),
('core.event.class', 'reported', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.reported', ''),
('core.event.class', 'requested', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.requested', ''),
('core.event.class', 'restored', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.actor.event.restored', ''),
('core.event.class', 'rewarded', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.rewarded', ''),
('core.event.class', 'sent', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.sent', ''),
('core.event.class', 'submitted', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.submitted', ''),
('core.event.class', 'suspended', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.actor.event.suspended', ''),
('core.event.class', 'transferred', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.transferred', ''),
('core.event.class', 'unlocked', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.user.agree', ''),
('core.event.class', 'viewed', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'core.event.class.viewed', ''),
('core.event.class', 'withdrawn', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.withdrawn', ''),
('core.event.class', 'withheld', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'dime.find.event.suppressed', ''),
