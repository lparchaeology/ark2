...
--
-- Host: localhost
-- Generation Time: Jan 23, 2018 at 11:51 PM
...
('dime.find', 'find', 'case', 'identifier', NULL, NULL, NULL, 'dime.find.read.case', 0, 0, 1, 1, 0, 'public', 1, 0, 'dime.find.case'),
...
('dime.find', 'find', 'museum_id', 'identifier', NULL, NULL, 'dime.find.update.museum_id', 'dime.find.read.museum_id', 0, 0, 1, 1, 0, 'restricted', 1, 0, 'dime.find.museum_id'),
