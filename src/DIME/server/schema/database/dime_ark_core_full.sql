...
--
-- Host: localhost:3306
-- Generation Time: Sep 23, 2017 at 11:40 AM
-- Server version: 10.1.23-MariaDB-9+deb9u1
-- PHP Version: 7.1.8-2+0~20170804100530.7+stretch~1.gbpae7f04
...
('dime.find', 'find', 'claim', 'file', 0, 0, 1, NULL, 1, 1, 'restricted', NULL, NULL, 1, 0, 'dime.find.claim'),
...
('da', 'dime.mappick.invalidpointlocation', 'default', 'Godkend', 'Du kan ikke angive dette fundsted. Kun fundsteder indenfor Danmarks grænser og på land kan gemmes i DIME.'),
