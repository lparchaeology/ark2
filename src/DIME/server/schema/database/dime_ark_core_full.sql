...
--
-- Host: localhost
-- Generation Time: Nov 10, 2017 at 05:42 PM
...
('da', 'core.action.suspend', 'default', 'suspendér???', NULL),
...
('da', 'core.actor.class.person', 'default', 'Rolle???', NULL),
...
('da', 'core.actor.person', 'default', 'Rolle???', NULL),
...
('da', 'core.file.class.audio', 'default', 'Audio???', NULL),
...
('da', 'core.user.reset.heading', 'default', 'Reset user???', NULL),
('da', 'core.user.reset.notregistered', 'default', 'Ikke registreret DIME-bruger?', NULL),
('da', 'core.user.reset.register', 'default', 'Opret ny bruger her???', NULL),
('da', 'core.user.reset.reset', 'default', 'Angiv dit brugernavn for at ændre dit password eller for at få adgang til din låste konto???', NULL),
...
('da', 'dime.action.cancel', 'default', 'Slet', NULL),
('da', 'dime.action.delete', 'default', 'Slet', NULL),
('da', 'dime.action.edit', 'default', 'Rediger', NULL),
...
('da', 'dime.action.suspend', 'default', 'suspendér???', NULL),
...
('da', 'dime.classification.explaination', 'default', 'Fundbeskrivelse – under konstruktion', ''),
...
('da', 'dime.find.artefact', 'default', 'Genstandstype???', NULL),
...
('da', 'dime.find.custodian', 'default', 'Samlingsansvarlig', ''),
('da', 'dime.find.custody', 'default', 'Opbevaringssted', ''),
('da', 'dime.find.custody.destroyed', 'default', 'Ødelagt', NULL),
('da', 'dime.find.custody.discarded', 'default', 'Kasseret', NULL),
('da', 'dime.find.custody.held', 'default', '-', ''),
...
('da', 'dime.find.dating', 'default', 'Datering', NULL),
...
('da', 'dime.find.event.accessioned', 'default', 'Indlemmet i samling???', NULL),
...
('da', 'dime.find.process.appraised', 'default', 'Vurderet', NULL),
...
('da', 'dime.find.subtype', 'default', 'Undertype???', NULL),
...
('da', 'dime.role.appraiser', 'default', 'Kurator???', NULL),
...
('da', 'dime.treasure.appraisal', 'default', 'Under vurdering', NULL),
('da', 'dime.treasure.not', 'default', 'Ikke Danefæ', NULL),
('da', 'dime.treasure.pending', 'default', 'under vurdering', ''),
('da', 'dime.treasure.treasure', 'default', 'Danefæ', NULL),
('da', 'dime.user.actor.museum', 'default', 'Lokalmuseum', NULL),
('da', 'dime.user.dashboard.faq', 'default', 'DIME NYHEDER: Test i Odense d. 21. oktober.', ''),
...
('da', 'dime.user.register.success', 'default', 'Tillykke! Du er nu registreret DIME-bruger. Du vil om et øjeblik modtage en mail, hvor du skal godkende oprettelsen af din brugerprofil. Indtil du er endelig godkendt (sker automatisk i løbet af få dage) vil du kunne registrere dine fund i DIME, men ikke videregive oplysninger om dit fund til det relevante lokalmuseum.', ''),
...
('en', 'dime.action.accession', 'default', 'Not Treasure - Accession to local museum collection', ''),
...
('en', 'dime.action.evaluate', 'default', 'Potential treasure - send for assessment', ''),
...
('en', 'dime.action.reject', 'default', 'Request more details from finder', ''),
('en', 'dime.action.release', 'default', 'Not Treasure - Return to finder', ''),
...
('dime_page_static', 'view', 'dime_site_header', 'dime_site_sidebar', NULL, 'dime_site_footer', 'public', NULL, NULL, NULL, NULL),
...
('core_actor_table', 'view', 0, 1, 0, 1, 1, 1, 0, 0, 0, 'row', NULL, 1, 1, NULL, '1', NULL, 'table-hover dime-table', NULL, NULL),
...
('dime_find_table', NULL, 0, 1, 0, 1, 1, 1, 0, 0, 0, 'row', NULL, 1, 1, NULL, '1', NULL, 'table-hover dime-table', NULL, NULL),
...
('core.file', 'view', 'core.event.class', 'viewed', NULL, 0, 0, 0, 0, 1, 'dime.action.view', 'View find record'),
('core.message', 'edit', 'core.event.class', 'edited', NULL, 0, 0, 0, 0, 1, 'dime.action.edit', 'Edit find record'),
('core.message', 'view', 'core.event.class', 'viewed', NULL, 0, 0, 0, 0, 1, 'dime.action.view', 'View find record'),
('core.page', 'edit', 'core.event.class', 'edited', NULL, 0, 0, 0, 0, 1, 'dime.action.edit', 'Edit find record'),
('core.page', 'view', 'core.event.class', 'viewed', NULL, 0, 0, 0, 0, 1, 'dime.action.view', 'View find record'),
