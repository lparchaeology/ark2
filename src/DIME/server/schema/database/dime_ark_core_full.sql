...
('da', 'core.user.password.change.success', 'default', 'Du har nu ændret dit password', NULL),
...
('da', 'core.user.register.success', 'default', 'Din registrering er nu afsendt. Tjek din mail og godkend oprettelsen af DIME-profilen???', NULL),
...
('da', 'dime.find.add.success', 'default', 'Tillykke! dit fund er nu regitreret i DIME???', NULL),
...
('da', 'dime.find.update.success', 'default', 'Opdatering gennemført???', NULL),
...
('da', 'dime.user.update.success', 'default', 'Brugerprofil opdateret', NULL),
