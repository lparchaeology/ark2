...
{
    public function render(Request $request, $class, $layout, $options = [], $template = 'pages/page.html.twig')
    {
        $list = ORM::findAll($class);
        $listLayout = ORM::find(Layout::class, $layout);
