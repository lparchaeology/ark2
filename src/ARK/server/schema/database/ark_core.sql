...
('from', 'translation.role.from', 'The start of the keyword'),
...
('to', 'translation.role.to', 'The end of the keyword');
...
CREATE TABLE `ark_view_option` (
  `element` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `opt` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cor_conf_subform` (
  `subform` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
