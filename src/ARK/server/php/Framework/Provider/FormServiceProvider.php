...
use ARK\Form\Extension\FormTypeExtension;
...
class FormServiceProvider implements ServiceProviderInterface
{
    ...
    {
        $container->register(new SilexFormServiceProvider());
        $container->extend('form.type.extensions', function ($extension, $container) {
