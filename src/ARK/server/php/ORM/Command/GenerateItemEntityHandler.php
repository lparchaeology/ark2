...
';
    ...
    public function __invoke(GenerateItemEntityMessage $message)
    {
        ...
        foreach ($types as $type) {
            $subclass = $this->generateEntitySubclass($message->namespace(), $type['classname'], $message->classname(), $module['entity']);
            $this->writeEntityClass($type['classname'], $subclass, ARK::autoloadDir($message->project()), $message->project());
        }
        /*
