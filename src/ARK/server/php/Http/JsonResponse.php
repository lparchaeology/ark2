...
use Symfony\Component\HttpFoundation\JsonResponse as FoundationResponse;

class JsonResponse extends FoundationResponse
{
    public function __construct($data = null, $status = 200, $additionalHeaders = [])
    {
        parent::__construct($data, $status, $additionalHeaders);
